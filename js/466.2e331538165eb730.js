(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[466], {
    895: function(t, e, r) {
        ...
        let n = r(9649)
          , i = r(5329)
          , a = n.glob.performance && n.glob.performance.now ? function() {
        ...
        class o {
            ...
            stop() {
                return o._removeAnimation(this),
                this
            }
            ...
            static _animationLoop() {
                o.animations.length ? (o._runFrames(),
                i.Util.requestAnimFrame(o._animationLoop)) : o.animRunning = !1
            }
    ...
    6962: function(t, e) {
        ...
        e.getCubicArcLength = (t,n,i)=>{
            ...
            for (let i = 0; i < 20; i++)
                ...
                o += e.cValues[20][i] * function(t, e, n) {
                    let i = r(1, n, t)
                      , a = r(1, n, e);
        ...
        e.getQuadraticArcLength = (t,e,r)=>{
            ...
            let n = t[0] - 2 * t[1] + t[2]
              ...
              , s = 4 * (n * n + i * i);
            if (0 === s)
                return r * Math.sqrt(Math.pow(t[2] - t[0], 2) + Math.pow(e[2] - e[0], 2));
            let l = 4 * (n * a + i * o) / (2 * s)
              , h = r + l
              , u = (a * a + o * o) / s - l * l
              , d = h * h + u > 0 ? Math.sqrt(h * h + u) : 0
              , c = l * l + u > 0 ? Math.sqrt(l * l + u) : 0;
            return Math.sqrt(s) / 2 * (h * d - l * c + (l + Math.sqrt(l * l + u) !== 0 ? u * Math.log(Math.abs((h + d) / (l + c))) : 0))
        }
        ;
        let r = (t,n,i)=>{
            let a, o;
            ...
            if (0 === t) {
                o = 0;
                for (let t = 0; t <= s; t++)
                    o += e.binomialCoefficients[s][t] * Math.pow(1 - n, s - t) * Math.pow(n, t) * i[t];
                return o
            }
            a = Array(s);
            for (let t = 0; t < s; t++)
    ...
    7193: function(t, e, r) {
        ...
        class h {
            constructor(t) {
                ...
                this.height = 0,
                this.isCache = !1;
                var e = (t || {}).pixelRatio || o.Konva.pixelRatio || function() {
                    if (n)
                        return n;
                    var t = i.Util.createCanvasElement()
                      , e = t.getContext("2d");
                    return n = (o.Konva._global.devicePixelRatio || 1) / (e.webkitBackingStorePixelRatio || e.mozBackingStorePixelRatio || e.msBackingStorePixelRatio || e.oBackingStorePixelRatio || e.backingStorePixelRatio || 1),
            ...
            toDataURL(t, e) {
                try {
                    ...
                    try {
                        ...
                        return i.Util.error("Unable to get data URL. " + t.message + " For more info read https://konvajs.org/docs/posts/Tainted_Canvas.html."),
                        ""
                    }
                }
            }
        ...
        e.Canvas = h,
        s.Factory.addGetterSetter(h, "pixelRatio", void 0, (0,
    ...
    9682: function(t, e, r) {
        ...
        class o extends i.Node {
            ...
            add(...t) {
                ...
                let r = t[0];
                return r.getParent() ? r.moveTo(this) : (this._validateAdd(r),
            ...
            _descendants(t) {
                for (let e of this.getChildren())
                    if (t(e) || e.hasChildren() && e._descendants(t))
                        return !0;
                return !1
            }
            toObject() {
            ...
            drawScene(t, e, r) {
                ...
                if (s) {
                    ...
                    this._drawChildren("drawScene", i, e, r);
                return this
            }
            drawHit(t, e) {
            ...
            _drawChildren(t, e, r, n) {
                var i, a = e && e.getContext(), o = this.clipWidth(), s = this.clipHeight(), l = this.clipFunc(), h = "number" == typeof o && "number" == typeof s || l;
                let u = r === this;
                if (h) {
                    let t;
                    a.save();
                    var d = this.getAbsoluteTransform(r)
                      , c = d.getMatrix();
                    if (a.transform(c[0], c[1], c[2], c[3], c[4], c[5]),
                    a.beginPath(),
                    l)
                ...
                var p = !u && "source-over" !== this.globalCompositeOperation() && "drawScene" === t;
                p && (a.save(),
                a._applyGlobalCompositeOperation(this)),
                null === (i = this.children) || void 0 === i || i.forEach(function(i) {
                    i[t](e, r, n)
                }),
                p && a.restore(),
                h && a.restore()
            ...
            getClientRect(t={}) {
                var e, r, n, i, a, o = t.skipTransform, s = t.relativeTo, l = {
                    x: 1 / 0,
                    y: 1 / 0,
                    width: 0,
                    height: 0
                ...
                null === (e = this.children) || void 0 === e || e.forEach(function(e) {
                    if (e.visible()) {
                        ...
                        (0 !== o.width || 0 !== o.height) && (void 0 === r ? (r = o.x,
                        n = o.y,
                        i = o.x + o.width,
                        a = o.y + o.height) : (r = Math.min(r, o.x),
                        n = Math.min(n, o.y),
                ...
                o) ? l : this._transformedRect(l, s)
            }
        }
        e.Container = o,
        n.Factory.addComponentsGetterSetter(o, "clip", ["x", "y", "width", "height"]),
        n.Factory.addGetterSetter(o, "clipX", void 0, (0,
        a.getNumberValidator)()),
        n.Factory.addGetterSetter(o, "clipY", void 0, (0,
        a.getNumberValidator)()),
        n.Factory.addGetterSetter(o, "clipWidth", void 0, (0,
        a.getNumberValidator)()),
        n.Factory.addGetterSetter(o, "clipHeight", void 0, (0,
        a.getNumberValidator)()),
    ...
    966: function(t, e, r) {
        ...
        class o {
            ...
            getTrace(t, e) {
                var r, i, a, o, s = this.traceArr, l = s.length, h = "";
                for (r = 0; r < l; r++)
                    (a = (i = s[r]).method) ? (o = i.args,
                    h += a,
                    t ? h += "()" : n.Util._isArray(o[0]) ? h += "([" + o.join(",") + "])" : (e && (o = o.map(t=>"number" == typeof t ? Math.floor(t) : t)),
                    h += "(" + o.join(",") + ")")) : (h += i.property,
                    t || (h += "=" + i.val)),
                    h += ";";
                return h
            }
            ...
            createImageData(t, e) {
                var r = arguments;
                return 2 === r.length ? this._context.createImageData(t, e) : 1 === r.length ? this._context.createImageData(t) : void 0
            }
            ...
            drawImage(t, e, r, n, i, a, o, s, l) {
                var h = arguments
                  , u = this._context;
                3 === h.length ? u.drawImage(t, e, r) : 5 === h.length ? u.drawImage(t, e, r, n, i) : 9 === h.length && u.drawImage(t, e, r, n, i, a, o, s, l)
            }
            ellipse(t, e, r, n, i, a, o, s) {
                this._context.ellipse(t, e, r, n, i, a, o, s)
            }
            isPointInPath(t, e, r, n) {
                return r ? this._context.isPointInPath(r, t, e, n) : this._context.isPointInPath(t, e, n)
            }
            fill(...t) {
            ...
            fillText(t, e, r, n) {
                n ? this._context.fillText(t, e, r, n) : this._context.fillText(t, e, r)
            }
            measureText(t) {
            ...
            _enableTrace() {
                var t, e, r = this, i = a.length, o = this.setAttr, s = function(t) {
                    var i, a = r[t];
                    r[t] = function() {
                        return e = function(t) {
                            var e, r, i = [], a = t.length, o = n.Util;
                            for (e = 0; e < a; e++)
                                r = t[e],
                                o._isNumber(r) ? r = Math.round(1e3 * r) / 1e3 : o._isString(r) || (r += ""),
                                i.push(r);
                            return i
        ...
        class s extends o {
            ...
            _fill(t) {
                ...
                e ? this._fillColor(t) : n ? this._fillPattern(t) : i ? this._fillLinearGradient(t) : a && this._fillRadialGradient(t)
            }
            ...
            _applyShadow(t) {
                var e, r, n, i = null !== (e = t.getShadowRGBA()) && void 0 !== e ? e : "black", a = null !== (r = t.getShadowBlur()) && void 0 !== r ? r : 5, o = null !== (n = t.getShadowOffset()) && void 0 !== n ? n : {
                    x: 0,
                    y: 0
                }, s = t.getAbsoluteScale(), l = this.canvas.getPixelRatio(), h = s.x * l, u = s.y * l;
    ...
    8790: function(t, e, r) {
        ...
        e.DD = {
            get isDragging() {
                var a = !1;
                return e.DD._dragElements.forEach(t=>{
            ...
            _drag(t) {
                ...
                e.DD._dragElements.forEach((e,n)=>{
                    ...
                    void 0 === e.pointerId && (e.pointerId = i.Util._getFirstPointerId(t));
                    let s = o._changedPointerPositions.find(t=>t.id === e.pointerId);
                    if (s) {
                        if ("dragging" !== e.dragStatus) {
                            var l = a.dragDistance();
                            if (Math.max(Math.abs(s.x - e.startPointerPos.x), Math.abs(s.y - e.startPointerPos.y)) < l || (a.startDrag({
                                evt: t
                            }),
                            !a.isDragging()))
                                return
                        }
                        a._setDragPosition(t, e),
                        r.push(a)
                    }
                }
                ),
            ...
            _endDragAfter(t) {
                e.DD._dragElements.forEach((r,n)=>{
                    "stopped" === r.dragStatus && r.node.fire("dragend", {
                        type: "dragend",
                        target: r.node,
                        evt: t
                    }, !0),
        ...
        n.Konva.isBrowser && (window.addEventListener("mouseup", e.DD._endDragBefore, !0),
        ...
        e.Factory = {
            ...
            overWriteSetter(t, e, r, i) {
                ...
                t.prototype[a] = function(t) {
                    return r && null != t && (t = r.call(this, t, e)),
                    this._setAttr(e, t),
                    i && i.call(this),
                    this
                }
            ...
            addComponentsGetterSetter(t, r, a, o, s) {
                var l, h, u = a.length, d = n.Util._capitalize, c = "get" + d(r), f = "set" + d(r);
                t.prototype[c] = function() {
                    var t = {};
                    for (l = 0; l < u; l++)
                        t[h = a[l]] = this.getAttr(r + d(h));
                    return t
                }
                ;
                var g = (0,
                i.getComponentValidator)(a);
                t.prototype[f] = function(t) {
                    var e, n = this.attrs[r];
                    for (e in o && (t = o.call(this, t)),
                    g && g.call(this, t, r),
                    t)
            ...
            addOverloadedGetterSetter(t, e) {
                ...
                t.prototype[e] = function() {
                    return arguments.length ? (this[i](arguments[0]),
                    this) : this[a]()
                }
            },
            addDeprecatedGetterSetter(t, r, i, a) {
                ...
                var o = "get" + n.Util._capitalize(r)
                  , s = r + " property is deprecated and will be removed soon. Look at Konva change log for more information.";
            ...
            backCompat(t, e) {
                n.Util.each(e, function(e, r) {
                    ...
                    function s() {
                        ...
                        n.Util.error('"' + e + '" method is deprecated and will be removed soon. Use ""' + r + '" instead.')
                    }
                    t.prototype[e] = s,
                    t.prototype[a] = s,
                    t.prototype[o] = s
    ...
    3006: function(t, e, r) {
        ...
        class o extends i.Layer {
            constructor(t) {
                super(t),
                this.listening(!1),
                n.Util.warn('Konva.Fast layer is deprecated. Please use "new Konva.Layer({ listening: false })" instead.')
            }
        }
        e.FastLayer = o,
    ...
    9649: function(t, e, r) {
        ...
        let n = Math.PI / 180;
        e.glob = void 0 !== r.g ? r.g : "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope ? self : {},
        e.Konva = {
            _global: e.glob,
            version: "9.3.6",
    ...
    2853: function(t, e, r) {
        ...
        class o extends i.Container {
            _validateAdd(t) {
                var e = t.getType();
                "Group" !== e && "Shape" !== e && n.Util.throw("You may only add groups and shapes to groups.")
            }
        }
        e.Group = o,
    ...
    6665: function(t, e, r) {
        ...
        class f extends i.Container {
            ...
            moveUp() {
                if (!a.Node.prototype.moveUp.call(this))
                    return !1;
                var t = this.getStage();
                return !!t && !!t.content && (t.content.removeChild(this.getNativeCanvasElement()),
            ...
            remove() {
                ...
                return a.Node.prototype.remove.call(this),
                t && t.parentNode && n.Util._isInDocument(t) && t.parentNode.removeChild(t),
                this
            }
            getStage() {
                return this.parent
            ...
            _validateAdd(t) {
                var e = t.getType();
                "Group" !== e && "Shape" !== e && n.Util.throw("You may only add groups and shapes to a layer.")
            }
            _toKonvaCanvas(t) {
            ...
            _getIntersection(t) {
                let e = this.hitCanvas.pixelRatio
                  , r = this.hitCanvas.context.getImageData(Math.round(t.x * e), Math.round(t.y * e), 1, 1).data
                  , i = r[3];
                if (255 === i) {
            ...
            drawHit(t, e) {
                var r = this.getLayer()
                  , n = t || r && r.hitCanvas;
                return r && r.clearBeforeDraw() && r.getHitCanvas().getContext().clear(),
            ...
            setHitGraphEnabled(t) {
                n.Util.warn("hitGraphEnabled method is deprecated. Please use layer.listening() instead."),
                this.listening(t)
            }
            getHitGraphEnabled(t) {
                return n.Util.warn("hitGraphEnabled method is deprecated. Please use layer.listening() instead."),
                this.listening()
            }
            toggleHitCanvas() {
            ...
            destroy() {
                return n.Util.releaseCanvas(this.getNativeCanvasElement(), this.getHitCanvas()._canvas),
                super.destroy()
            }
        }
        e.Layer = f,
        ...
        o.Factory.addGetterSetter(f, "hitGraphEnabled", !0, (0,
        l.getBooleanValidator)())
    },
    4667: function(t, e, r) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
        ...
        class x {
            ...
            _clearCache(t) {
                (t === b || t === d) && this._cache.get(t) ? this._cache.get(t).dirty = !0 : t ? this._cache.delete(t) : this._cache.clear()
            }
            _getCache(t, e) {
                var r = this._cache.get(t)
                  , n = t === b || t === d;
                return (void 0 === r || n && !0 === r.dirty) && (r = e.call(this),
                this._cache.set(t, r)),
                r
            }
            _calculate(t, e, r) {
            ...
            cache(t) {
                var e = t || {}
                  , r = {};
                (void 0 === e.x || void 0 === e.y || void 0 === e.width || void 0 === e.height) && (r = this.getClientRect({
                    skipTransform: !0,
                ...
                let v = Math.abs(Math.round(r.x) - l) > .5 ? 1 : 0
                  , m = Math.abs(Math.round(r.y) - u) > .5 ? 1 : 0;
                i += 2 * d + v,
                o += 2 * d + m,
                l -= d,
                u -= d;
                ...
                this._cache.delete(f),
                this._filterUpToDate = !1,
                !1 === e.imageSmoothingEnabled && (y.getContext()._context.imageSmoothingEnabled = !1,
            ...
            _drawCachedSceneCanvas(t) {
                ...
                var r = this._getCachedSceneCanvas()
                  , n = r.pixelRatio;
                t.drawImage(r._canvas, 0, 0, r.width / n, r.height / n),
                t.restore()
            }
            _drawCachedHitCanvas(t) {
                ...
                t.save(),
                t.translate(e.x, e.y),
                t.drawImage(r._canvas, 0, 0, r.width / r.pixelRatio, r.height / r.pixelRatio),
                t.restore()
            }
            _getCachedSceneCanvas() {
                var t, e, r, i, a = this.filters(), o = this._getCanvasCache(), s = o.scene, l = o.filter, h = l.getContext();
                if (a) {
                    if (!this._filterUpToDate) {
                        ...
                        try {
                            for (t = a.length,
                            h.clear(),
                            h.drawImage(s._canvas, 0, 0, s.getWidth() / u, s.getHeight() / u),
                            e = h.getImageData(0, 0, l.getWidth(), l.getHeight()),
                            r = 0; r < t; r++) {
                                if (i = a[r],
                                "function" != typeof i) {
                                    n.Util.error("Filter should be type of function, but got " + typeof i + " instead. Please check correct filters");
                                    continue
                                }
                                i.call(this, e),
                            ...
                            n.Util.error("Unable to apply filter. " + t.message + " This post my help you https://konvajs.org/docs/posts/Tainted_Canvas.html.")
                        }
            ...
            on(t, e) {
                if (this._cache && this._cache.delete(u),
                3 == arguments.length)
                    return this._delegate.apply(this, arguments);
                var r, n, i, a, o = t.split(" "), s = o.length;
                for (r = 0; r < s; r++)
                    i = (n = o[r].split("."))[0],
                    a = n[1] || "",
            ...
            off(t, e) {
                var r, n, i, a, o, s = (t || "").split(" "), l = s.length;
                if (this._cache && this._cache.delete(u),
                !t)
            ...
            _delegate(t, e, r) {
                ...
                this.on(t, function(t) {
                    for (var a = t.target.findAncestors(e, !0, i), o = 0; o < a.length; o++)
            ...
            setAttrs(t) {
                return this._batchTransformChanges(()=>{
                    ...
                    if (!t)
                        return this;
                    for (e in t)
                        "children" !== e && (r = "set" + n.Util._capitalize(e),
                        n.Util._isFunction(this[r]) ? this[r](t[e]) : this._setAttr(e, t[e]))
                }
                ),
                this
            }
            ...
            shouldDrawHit(t, e=!1) {
                ...
                s.DD._dragElements.forEach(t=>{
                    "dragging" === t.dragStatus && ("Stage" === t.node.nodeType ? n = !0 : t.node.getLayer() === r && (n = !0))
                }
                );
                var i = !e && !o.Konva.hitOnDragEnabled && (n || o.Konva.isTransforming());
            ...
            getAbsoluteZIndex() {
                var t, e, r, n, i = this.getDepth(), a = this, o = 0;
                let s = this.getStage();
                return "Stage" !== a.nodeType && s && function s(l) {
                    for (r = 0,
                    t = [],
                    e = l.length; r < e; r++)
                        n = l[r],
            ...
            _batchTransformChanges(t) {
                ...
                t(),
                this._batchingTransformChange = !1,
                this._needClearTransformCache && (this._clearCache(b),
                this._clearSelfAndDescendantCache(d)),
                this._needClearTransformCache = !1
            }
            setPosition(t) {
            ...
            moveToTop() {
                if (!this.parent)
                    return n.Util.warn("Node has no parent. moveToTop function is ignored."),
                    !1;
                var t = this.index;
            ...
            moveUp() {
                if (!this.parent)
                    return n.Util.warn("Node has no parent. moveUp function is ignored."),
                    !1;
                var t = this.index;
                return t < this.parent.getChildren().length - 1 && (this.parent.children.splice(t, 1),
            ...
            moveDown() {
                if (!this.parent)
                    return n.Util.warn("Node has no parent. moveDown function is ignored."),
                    !1;
                var t = this.index;
            ...
            moveToBottom() {
                if (!this.parent)
                    return n.Util.warn("Node has no parent. moveToBottom function is ignored."),
                    !1;
                var t = this.index;
                return t > 0 && (this.parent.children.splice(t, 1),
            ...
            setZIndex(t) {
                if (!this.parent)
                    return n.Util.warn("Node has no parent. zIndex parameter is ignored."),
                    this;
                (t < 0 || t >= this.parent.children.length) && n.Util.warn("Unexpected value " + t + " for zIndex property. zIndex is just index of a node in children of its parent. Expected value is from 0 to " + (this.parent.children.length - 1) + ".");
                var e = this.index;
            ...
            toObject() {
                ...
                for (t in a)
                    e = a[t],
                    (!n.Util.isObject(e) || n.Util._isPlainObject(e) || n.Util._isArray(e)) && (r = "function" == typeof this[t] && this[t],
                    delete a[t],
            ...
            _isMatch(t) {
                ...
                if ("function" == typeof t)
                    return t(this);
                var e, r, i = t.replace(/ /g, "").split(","), a = i.length;
                for (e = 0; e < a; e++)
                    if (r = i[e],
                    n.Util.isValidSelector(r) || (n.Util.warn('Selector "' + r + '" is invalid. Allowed selectors examples are "#foo", ".bar" or "Group".'),
                    n.Util.warn('If you have a custom shape with such className, please change it to start with upper letter like "Triangle".'),
            ...
            getAbsoluteTransform(t) {
                return t ? this._getAbsoluteTransform(t) : this._getCache(d, this._getAbsoluteTransform)
            }
            _getAbsoluteTransform(t) {
                if (t)
                    return e = new n.Transform,
                    this._eachAncestorReverse(function(t) {
                        var r = t.transformsEnabled();
                        "all" === r ? e.multiply(t.getTransform()) : "position" === r && e.translate(t.x() - t.offsetX(), t.y() - t.offsetY())
                    }, t),
                    e;
                e = this._cache.get(d) || new n.Transform,
                this.parent ? this.parent.getAbsoluteTransform().copyInto(e) : e.reset();
                var e, r = this.transformsEnabled();
                if ("all" === r)
            ...
            _getTransform() {
                var t, e, r = this._cache.get(b) || new n.Transform;
                r.reset();
                var i = this.x()
                  , a = this.y()
                ...
                return (0 !== i || 0 !== a) && r.translate(i, a),
                0 !== s && r.rotate(s),
                (0 !== u || 0 !== d) && r.skew(u, d),
                (1 !== l || 1 !== h) && r.scale(l, h),
            ...
            clone(t) {
                var e, r, i, a, o, s = n.Util.cloneObject(this.attrs);
                for (e in t)
                    s[e] = t[e];
                var l = new this.constructor(s);
                for (e in this.eventListeners)
                    for (a = 0,
                    i = (r = this.eventListeners[e]).length; a < i; a++)
                        0 > (o = r[a]).name.indexOf("konva") && (l.eventListeners[e] || (l.eventListeners[e] = []),
            ...
            _toKonvaCanvas(t) {
                ...
                return !1 === t.imageSmoothingEnabled && (l._context.imageSmoothingEnabled = !1),
                l.save(),
            ...
            getDragDistance() {
                return void 0 !== this.attrs.dragDistance ? this.attrs.dragDistance : this.parent ? this.parent.getDragDistance() : o.Konva.dragDistance
            }
            _off(t, e, r) {
                var n, i, a, o = this.eventListeners[t];
                for (n = 0; n < o.length; n++)
                    if (i = o[n].name,
                    a = o[n].handler,
                    ("konva" !== i || "konva" === e) && (!e || i === e) && (!r || r === a)) {
                        if (o.splice(n, 1),
                        0 === o.length) {
            ...
            setAttr(t, e) {
                ...
                return n.Util._isFunction(r) ? r.call(this, e) : this._setAttr(t, e),
                this
            }
            _requestDraw() {
            ...
            _setAttr(t, e) {
                var r = this.attrs[t];
                (r !== e || n.Util.isObject(e)) && (null == e ? delete this.attrs[t] : this.attrs[t] = e,
                this._shouldFireChangeEvents && this._fireChangeEvent(t, r, e),
                this._requestDraw())
            }
            _setComponentAttr(t, e, r) {
                var n;
                void 0 !== r && ((n = this.attrs[t]) || (this.attrs[t] = this.getAttr(t)),
                this.attrs[t][e] = r,
                this._fireChangeEvent(t, n, r))
            }
            _fireAndBubble(t, e, r) {
                if (e && this.nodeType === m && (e.target = this),
                !((t === p || t === v) && (r && (this === r || this.isAncestorOf && this.isAncestorOf(r)) || "Stage" === this.nodeType && !r))) {
                    this._fire(t, e);
                    var n = (t === p || t === v) && r && r.isAncestorOf && r.isAncestorOf(this) && !r.isAncestorOf(this.parent);
                    (e && !e.cancelBubble || !e) && this.parent && this.parent.isListening() && !n && (r && r.parent ? this._fireAndBubble.call(this.parent, t, e, r) : this._fireAndBubble.call(this.parent, t, e))
                }
            }
            _getProtoListeners(t) {
                ...
                if (void 0 === a) {
                    ...
                    for (; e; ) {
                        let i = null !== (n = null === (r = e.eventListeners) || void 0 === r ? void 0 : r[t]) && void 0 !== n ? n : [];
                        a.push(...i),
            ...
            _setDragPosition(t, e) {
                ...
                if (r) {
                    ...
                    if (void 0 !== a) {
                        ...
                        e ? i = e : n.Util.warn("dragBoundFunc did not return any value. That is unexpected behavior. You must return new absolute position from dragBoundFunc.")
                    }
            ...
            _listenDrag() {
                ...
                this.on("mousedown.konva touchstart.konva", function(t) {
                    if (!(!(!(void 0 !== t.evt.button) || o.Konva.dragButtons.indexOf(t.evt.button) >= 0) || this.isDragging())) {
                        var e = !1;
                        s.DD._dragElements.forEach(t=>{
            ...
            static create(t, e) {
                return n.Util._isString(t) && (t = JSON.parse(t)),
                this._createNode(t, e)
            }
            static _createNode(t, e) {
                var r, i, a, s = x.prototype.getClassName.call(t), l = t.children;
                if (e && (t.attrs.container = e),
                o.Konva[s] || (n.Util.warn('Can not find a node with class name "' + s + '". Fallback to "Shape".'),
                s = "Shape"),
                r = new o.Konva[s](t.attrs),
                l)
                    for (a = 0,
                    i = l.length; a < i; a++)
                        r.add(x._createNode(l[a]));
                return r
            }
        }
        e.Node = x,
        ...
        x.prototype.on.call(x.prototype, "xChange.konva yChange.konva scaleXChange.konva scaleYChange.konva skewXChange.konva skewYChange.konva rotationChange.konva offsetXChange.konva offsetYChange.konva transformsEnabledChange.konva", function() {
        ...
        w(x, "y", 0, (0,
        l.getNumberValidator)()),
        w(x, "globalCompositeOperation", "source-over", (0,
        l.getStringValidator)()),
        w(x, "opacity", 1, (0,
        l.getNumberValidator)()),
        w(x, "name", "", (0,
        l.getStringValidator)()),
    ...
    6453: function(t, e, r) {
        ...
        function s(t, e) {
            ...
            n && n.content,
            i.delete(t),
            a && r._fire("lostpointercapture", o(new PointerEvent("lostpointercapture")))
        }
        ...
        e.setPointerCapture = function(t, e) {
            s(t),
            e.getStage() && (i.set(t, e),
            a && e._fire("gotpointercapture", o(new PointerEvent("gotpointercapture"))))
        }
        ,
        e.releaseCapture = s
    },
    7439: function(t, e, r) {
        ...
        class m extends s.Node {
            ...
            getContext() {
                return a.Util.warn("shape.getContext() method is deprecated. Please do not use it."),
                this.getLayer().getContext()
            }
            getCanvas() {
                return a.Util.warn("shape.getCanvas() method is deprecated. Please do not use it."),
            ...
            __getFillPattern() {
                if (this.fillPatternImage()) {
                    let t = v().createPattern(this.fillPatternImage(), this.fillPatternRepeat() || "repeat");
                    if (t && t.setTransform) {
            ...
            __getLinearGradient() {
                ...
                if (t) {
                    for (var e = v(), r = this.fillLinearGradientStartPoint(), n = this.fillLinearGradientEndPoint(), i = e.createLinearGradient(r.x, r.y, n.x, n.y), a = 0; a < t.length; a += 2)
            ...
            __getRadialGradient() {
                ...
                if (t) {
                    for (var e = v(), r = this.fillRadialGradientStartPoint(), n = this.fillRadialGradientEndPoint(), i = e.createRadialGradient(r.x, r.y, this.fillRadialGradientStartRadius(), n.x, n.y, this.fillRadialGradientEndRadius()), a = 0; a < t.length; a += 2)
                        i.addColorStop(t[a], t[a + 1]);
                    return i
                }
            }
            ...
            intersects(t) {
                ...
                return r.getContext().clear(),
                this.drawHit(r, void 0, !0),
                r.context.getImageData(Math.round(t.x), Math.round(t.y), 1, 1).data[3] > 0
            }
            destroy() {
                return s.Node.prototype.destroy.call(this),
            ...
            setStrokeHitEnabled(t) {
                a.Util.warn("strokeHitEnabled property is deprecated. Please use hitStrokeWidth instead."),
            ...
            getClientRect(t={}) {
                let e = t.skipTransform
                  ...
                  , d = {
                    width: a + Math.abs(l) + 2 * u,
                    height: o + Math.abs(h) + 2 * u,
                    x: -(i / 2 + u) + Math.min(l, 0) + n.x,
                    y: -(i / 2 + u) + Math.min(h, 0) + n.y
                };
                return e ? d : this._transformedRect(d, r)
            }
            drawScene(t, e, r) {
                var n, i, a = this.getLayer(), o = t || a.getCanvas(), s = o.getContext(), l = this._getCanvasCache(), h = this.getSceneFunc(), u = this.hasShadow(), d = o.isCache, c = e === this;
                if (!this.isVisible() && !c)
                    return this;
                if (l) {
                    s.save();
                    var f = this.getAbsoluteTransform(e).getMatrix();
                    return s.transform(f[0], f[1], f[2], f[3], f[4], f[5]),
                ...
                if (!h)
                    return this;
                if (s.save(),
                this._useBufferCanvas() && !d) {
                    n = this.getStage();
                    let t = r || n.bufferCanvas;
                    (i = t.getContext()).clear(),
                    i.save(),
            ...
            drawHit(t, e, r=!1) {
                ...
                var n = this.getLayer()
                  ...
                  , h = l && l.hit;
                if (this.colorKey || a.Util.warn("Looks like your canvas has a destroyed shape in it. Do not reuse shape after you destroyed it. If you want to reuse shape you should call remove() instead of destroy()"),
                h) {
                    o.save();
                    var u = this.getAbsoluteTransform(e).getMatrix();
                    return o.transform(u[0], u[1], u[2], u[3], u[4], u[5]),
            ...
            drawHitFromCache(t=0) {
                var e, r, n, i, o, s = this._getCanvasCache(), l = this._getCachedSceneCanvas(), h = s.hit, u = h.getContext(), d = h.getWidth(), c = h.getHeight();
                u.clear(),
                u.drawImage(l._canvas, 0, 0, d, c);
                try {
                    for (o = 0,
                    n = (r = (e = u.getImageData(0, 0, d, c)).data).length,
                    i = a.Util._hexToRgb(this.colorKey); o < n; o += 4)
                        r[o + 3] > t ? (r[o] = i.r,
                        r[o + 1] = i.g,
                        r[o + 2] = i.b,
                        r[o + 3] = 255) : r[o + 3] = 0;
        ...
        m.prototype.on.call(m.prototype, "shadowColorChange.konva shadowBlurChange.konva shadowOffsetChange.konva shadowOpacityChange.konva shadowEnabledChange.konva", function() {
            this._clearCache(d)
        }),
        ...
        o.Factory.addGetterSetter(m, "stroke", void 0, (0,
        l.getStringOrGradientValidator)()),
        o.Factory.addGetterSetter(m, "strokeWidth", 2, (0,
        l.getNumberValidator)()),
        o.Factory.addGetterSetter(m, "fillAfterStrokeEnabled", !1),
        o.Factory.addGetterSetter(m, "hitStrokeWidth", "auto", (0,
        l.getNumberOrAutoValidator)()),
        o.Factory.addGetterSetter(m, "strokeHitEnabled", !0, (0,
        l.getBooleanValidator)()),
        o.Factory.addGetterSetter(m, "perfectDrawEnabled", !0, (0,
        l.getBooleanValidator)()),
        o.Factory.addGetterSetter(m, "shadowForStrokeEnabled", !0, (0,
        l.getBooleanValidator)()),
        ...
        o.Factory.addGetterSetter(m, "dashOffset", 0, (0,
        l.getNumberValidator)()),
        o.Factory.addGetterSetter(m, "shadowColor", void 0, (0,
        l.getStringValidator)()),
        o.Factory.addGetterSetter(m, "shadowBlur", 0, (0,
        l.getNumberValidator)()),
        o.Factory.addGetterSetter(m, "shadowOpacity", 1, (0,
        l.getNumberValidator)()),
        o.Factory.addComponentsGetterSetter(m, "shadowOffset", ["x", "y"]),
        o.Factory.addGetterSetter(m, "shadowOffsetX", 0, (0,
        l.getNumberValidator)()),
        o.Factory.addGetterSetter(m, "shadowOffsetY", 0, (0,
        l.getNumberValidator)()),
        o.Factory.addGetterSetter(m, "fillPatternImage"),
        o.Factory.addGetterSetter(m, "fill", void 0, (0,
        l.getStringOrGradientValidator)()),
        o.Factory.addGetterSetter(m, "fillPatternX", 0, (0,
        l.getNumberValidator)()),
        o.Factory.addGetterSetter(m, "fillPatternY", 0, (0,
        l.getNumberValidator)()),
        ...
        o.Factory.addGetterSetter(m, "fillPatternOffsetX", 0, (0,
        l.getNumberValidator)()),
        o.Factory.addGetterSetter(m, "fillPatternOffsetY", 0, (0,
        l.getNumberValidator)()),
        o.Factory.addComponentsGetterSetter(m, "fillPatternScale", ["x", "y"]),
        o.Factory.addGetterSetter(m, "fillPatternScaleX", 1, (0,
        l.getNumberValidator)()),
        o.Factory.addGetterSetter(m, "fillPatternScaleY", 1, (0,
        l.getNumberValidator)()),
        o.Factory.addComponentsGetterSetter(m, "fillLinearGradientStartPoint", ["x", "y"]),
        o.Factory.addComponentsGetterSetter(m, "strokeLinearGradientStartPoint", ["x", "y"]),
        ...
        o.Factory.addComponentsGetterSetter(m, "fillLinearGradientEndPoint", ["x", "y"]),
        o.Factory.addComponentsGetterSetter(m, "strokeLinearGradientEndPoint", ["x", "y"]),
        ...
        o.Factory.addComponentsGetterSetter(m, "fillRadialGradientStartPoint", ["x", "y"]),
        o.Factory.addGetterSetter(m, "fillRadialGradientStartPointX", 0),
        o.Factory.addGetterSetter(m, "fillRadialGradientStartPointY", 0),
        o.Factory.addComponentsGetterSetter(m, "fillRadialGradientEndPoint", ["x", "y"]),
        ...
        o.Factory.addGetterSetter(m, "fillRule", void 0, (0,
        l.getStringValidator)()),
    ...
    9144: function(t, e, r) {
        ...
        var d = "mouseleave"
          ...
          , E = "touchcancel"
          , N = "wheel"
          , M = [[f, "_pointerenter"], [p, "_pointerdown"], [g, "_pointermove"], [v, "_pointerup"], [d, "_pointerleave"], [P, "_pointerdown"], [F, "_pointermove"], [T, "_pointerup"], [E, "_pointercancel"], [c, "_pointerover"], [N, "_wheel"], [k, "_contextmenu"], [y, "_pointerdown"], [m, "_pointermove"], [b, "_pointerup"], [_, "_pointercancel"], ["lostpointercapture", "_lostpointercapture"]];
        let A = {
            mouse: {
                [S]: "mouseout",
                [x]: d,
          ...
          , R = t=>t.indexOf("pointer") >= 0 ? "pointer" : t.indexOf("touch") >= 0 ? "touch" : "mouse"
          , D = t=>{
            let e = R(t);
            return "pointer" === e ? o.Konva.pointerEventsEnabled && A.pointer : "touch" === e ? A.touch : "mouse" === e ? A.mouse : void 0
        }
        ;
        function L(t={}) {
            return (t.clipFunc || t.clipWidth || t.clipHeight) && n.Util.warn("Stage does not support clipping. Please use clip for Layers or Groups."),
            t
        }
        e.stages = [];
        class I extends a.Container {
            ...
            clear() {
                var t, e = this.children, r = e.length;
                for (t = 0; t < r; t++)
                    e[t].clear();
                return this
            }
            ...
            destroy() {
                ...
                return r > -1 && e.stages.splice(r, 1),
            ...
            getPointerPosition() {
                ...
                return t ? {
                    x: t.x,
                    y: t.y
                } : (n.Util.warn("Pointer position is missing and not registered by the stage. Looks like it is outside of the stage container. You can set it manually from event: stage.setPointersPositions(event);"),
                null)
            }
            _getPointerById(t) {
            ...
            _toKonvaCanvas(t) {
                ...
                var e = new s.SceneCanvas({
                  ...
                  , n = this.children;
                return (t.x || t.y) && r.translate(-1 * t.x, -1 * t.y),
                n.forEach(function(e) {
                    if (e.isVisible()) {
                        var n = e._toKonvaCanvas(t);
                        r.drawImage(n._canvas, t.x, t.y, n.getWidth() / n.getPixelRatio(), n.getHeight() / n.getPixelRatio())
                    }
                }),
                e
            }
            ...
            add(t, ...e) {
                ...
                return i > 5 && n.Util.warn("The stage has " + i + " layers. Recommended maximum number of layers is 3-5. Adding more layers into the stage may drop the performance. Rethink your tree structure, you can use Konva.Group."),
                t.setSize({
                    width: this.width(),
                    height: this.height()
                }),
            ...
            _bindContentEvents() {
                o.Konva.isBrowser && M.forEach(([t,e])=>{
            ...
            _pointerleave(t) {
                ...
                if (e) {
                    ...
                    var n = this._getTargetShape(r)
                      , i = !(o.Konva.isDragging() || o.Konva.isTransforming()) || o.Konva.hitOnDragEnabled;
                    n && i ? (n._fireAndBubble(e.pointerout, {
                        evt: t
                    }),
                    ...
                    this[r + "targetShape"] = null) : i && (this._fire(e.pointerleave, {
                        evt: t,
                        target: this,
                        currentTarget: this
                    }),
            ...
            _pointermove(t) {
                let e = D(t.type)
                  , r = R(t.type);
                if (!e || (o.Konva.isDragging() && l.DD.node.preventDefault() && t.cancelable && t.preventDefault(),
                this.setPointersPositions(t),
                !(!(o.Konva.isDragging() || o.Konva.isTransforming()) || o.Konva.hitOnDragEnabled)))
                    return;
                var n = {};
                let i = !1;
                ...
                this._changedPointerPositions.forEach(o=>{
                    ...
                    s && s.isListening() ? (i = !0,
                    d && (s._fireAndBubble(e.pointerover, {
                        ...h
                    }, a),
                    s._fireAndBubble(e.pointerenter, {
                        ...h
                    }, a),
            ...
            _pointerup(t) {
                ...
                this._changedPointerPositions.forEach(h=>{
                    ...
                    let c = h.id
                      ...
                      , g = !1;
                    o.Konva["_" + r + "InDblClickWindow"] ? (g = !0,
                    clearTimeout(this[r + "DblTimeout"])) : l.DD.justDragged || (o.Konva["_" + r + "InDblClickWindow"] = !0,
                    ...
                    o.Konva["_" + r + "ListenClick"] && n && n === d && (d._fireAndBubble(e.pointerclick, {
                        ...f
                    }),
                    g && i && i === d && d._fireAndBubble(e.pointerdblclick, {
                        ...f
                    }))) : (this[r + "ClickEndShape"] = null,
                    o.Konva["_" + r + "ListenClick"] && this._fire(e.pointerclick, {
                        evt: t,
                        target: this,
                        currentTarget: this,
                        pointerId: c
            ...
            _wheel(t) {
                this.setPointersPositions(t);
                var e = this.getIntersection(this.getPointerPosition());
                e && e.isListening() ? e._fireAndBubble(N, {
                    evt: t
                }) : this._fire(N, {
                    evt: t,
                    target: this,
            ...
            _pointercancel(t) {
                this.setPointersPositions(t);
                let e = u.getCapturedShape(t.pointerId) || this.getIntersection(this.getPointerPosition());
            ...
            _setPointerPosition(t) {
                n.Util.warn('Method _setPointerPosition is deprecated. Use "stage.setPointersPositions(event)" instead.'),
                this.setPointersPositions(t)
            }
            _getContentPosition() {
            ...
            cache() {
                return n.Util.warn("Cache function is not allowed for stage. You may use cache only for layers, groups and shapes."),
                this
            }
            clearCache() {
                return this
    ...
    7658: function(t, e, r) {
        ...
        class d {
            constructor(t) {
                var r, a, h = this, c = t.node, f = c._id, g = t.easing || e.Easings.Linear, p = !!t.yoyo;
                r = void 0 === t.duration ? .3 : 0 === t.duration ? .001 : t.duration,
                this.node = c,
                this._id = l++;
                var v = c.getLayer() || (c instanceof o.Konva.Stage ? c.getLayers() : null);
                for (a in v || n.Util.error("Tween constructor have `node` that is not in a layer. Please add node into layer first."),
                this.anim = new i.Animation(function() {
                    h.tween.onEnterFrame()
                }
                ,v),
                this.tween = new u(a,function(t) {
                    h._tweenFunc(t)
                }
                ,g,0,1,1e3 * r,p),
                this._addListeners(),
            ...
            _addAttr(t, e) {
                var r, i, a, o, s, l, u, c, f = this.node, g = f._id;
                if ((a = d.tweens[g][t]) && delete d.attrs[g][a][t],
                r = f.getAttr(t),
                n.Util._isArray(e)) {
                    if (i = [],
                    s = Math.max(e.length, r.length),
                    "points" === t && e.length !== r.length && (e.length > r.length ? (u = r,
                    r = n.Util._prepareArrayForTween(r, e, f.closed())) : (l = e,
                    ...
                    -1 !== h.indexOf(t) ? (r = n.Util.colorToRGBA(r),
                    i = {
            ...
            _tweenFunc(t) {
                var e, r, i, a, o, s, l, u, c = this.node, f = d.attrs[c._id][this._id];
                for (e in f) {
                    if (i = (r = f[e]).start,
                    a = r.diff,
                    u = r.end,
                    n.Util._isArray(i)) {
                        ...
                        0 === e.indexOf("fill"))
                            for (s = 0; s < l; s++)
                                s % 2 == 0 ? o.push((i[s] || 0) + a[s] * t) : o.push("rgba(" + Math.round(i[s].r + a[s].r * t) + "," + Math.round(i[s].g + a[s].g * t) + "," + Math.round(i[s].b + a[s].b * t) + "," + (i[s].a + a[s].a * t) + ")");
                        else
                            for (s = 0; s < l; s++)
                                o.push((i[s] || 0) + a[s] * t)
                    } else
                        o = -1 !== h.indexOf(e) ? "rgba(" + Math.round(i.r + a.r * t) + "," + Math.round(i.g + a.g * t) + "," + Math.round(i.b + a.b * t) + "," + (i.a + a.a * t) + ")" : i + a * t;
                    c.setAttr(e, o)
                }
            }
            _addListeners() {
            ...
            destroy() {
                var t, e = this.node._id, r = this._id, n = d.tweens[e];
                for (t in this.pause(),
                n)
                    delete d.tweens[e][t];
                delete d.attrs[e][r]
        ...
        ,
        e.Easings = {
            BackEaseIn: (t,e,r,n)=>r * (t /= n) * t * (2.70158 * t - 1.70158) + e,
            BackEaseOut: (t,e,r,n)=>r * ((t = t / n - 1) * t * (2.70158 * t + 1.70158) + 1) + e,
            ...
            ElasticEaseIn(t, e, r, n, i, a) {
                ...
                -(i * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * Math.PI * (t * n - o) / a)) + e)
            },
            ElasticEaseOut(t, e, r, n, i, a) {
                ...
                !i || i < Math.abs(r) ? (i = r,
                o = a / 4) : o = a / (2 * Math.PI) * Math.asin(r / i),
                i * Math.pow(2, -10 * t) * Math.sin(2 * Math.PI * (t * n - o) / a) + r + e)
            },
            ElasticEaseInOut(t, e, r, n, i, a) {
                var o = 0;
                return 0 === t ? e : 2 == (t /= n / 2) ? e + r : (a || (a = .3 * 1.5 * n),
                !i || i < Math.abs(r) ? (i = r,
                o = a / 4) : o = a / (2 * Math.PI) * Math.asin(r / i),
                t < 1) ? -(i * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * Math.PI * (t * n - o) / a) * .5) + e : i * Math.pow(2, -10 * (t -= 1)) * Math.sin(2 * Math.PI * (t * n - o) / a) * .5 + r + e
            },
            BounceEaseOut: (t,e,r,n)=>(t /= n) < 1 / 2.75 ? 7.5625 * t * t * r + e : t < 2 / 2.75 ? r * (7.5625 * (t -= 1.5 / 2.75) * t + .75) + e : t < 2.5 / 2.75 ? r * (7.5625 * (t -= 2.25 / 2.75) * t + .9375) + e : r * (7.5625 * (t -= 2.625 / 2.75) * t + .984375) + e,
            BounceEaseIn: (t,r,n,i)=>n - e.Easings.BounceEaseOut(i - t, 0, n, i) + r,
            BounceEaseInOut: (t,r,n,i)=>t < i / 2 ? .5 * e.Easings.BounceEaseIn(2 * t, 0, n, i) + r : .5 * e.Easings.BounceEaseOut(2 * t - i, 0, n, i) + .5 * n + r,
            EaseIn: (t,e,r,n)=>r * (t /= n) * t + e,
            EaseOut: (t,e,r,n)=>-r * (t /= n) * (t - 2) + e,
            EaseInOut: (t,e,r,n)=>(t /= n / 2) < 1 ? r / 2 * t * t + e : -r / 2 * (--t * (t - 2) - 1) + e,
            StrongEaseIn: (t,e,r,n)=>r * (t /= n) * t * t * t * t + e,
            StrongEaseOut: (t,e,r,n)=>r * ((t = t / n - 1) * t * t * t * t + 1) + e,
            StrongEaseInOut: (t,e,r,n)=>(t /= n / 2) < 1 ? r / 2 * t * t * t * t * t + e : r / 2 * ((t -= 2) * t * t * t * t + 2) + e,
    ...
    5329: function(t, e, r) {
        ...
        class i {
            ...
            decompose() {
                ...
                if (0 != t || 0 != r) {
                    ...
                    l.rotation = Math.PI / 2 - (i > 0 ? Math.acos(-n / u) : -Math.acos(n / u)),
                    l.scaleX = s / u,
                    l.scaleY = u,
                    l.skewX = 0,
                    l.skewY = (t * n + r * i) / s
                }
                return l.rotation = e.Util._getRotation(l.rotation),
                l
            }
        }
        e.Transform = i;
        var a = Math.PI / 180
          ...
          , u = [];
        let d = "undefined" != typeof requestAnimationFrame && requestAnimationFrame || function(t) {
            setTimeout(t, 60)
        }
        ;
        e.Util = {
            ...
            _rgbToHex: (t,e,r)=>(16777216 + (t << 16) + (e << 8) + r).toString(16).slice(1),
            _hexToRgb(t) {
            ...
            getRGB(t) {
                ...
                return t in l ? {
                    ...
                    g: e[1],
                    b: e[2]
                } : "#" === t[0] ? this._hexToRgb(t.substring(1)) : "rgb(" === t.substr(0, 4) ? {
            ...
            e.Util._namedColorToRBA(t) || e.Util._hex3ColorToRGBA(t) || e.Util._hex4ColorToRGBA(t) || e.Util._hex6ColorToRGBA(t) || e.Util._hex8ColorToRGBA(t) || e.Util._rgbColorToRGBA(t) || e.Util._rgbaColorToRGBA(t) || e.Util._hslColorToRGBA(t)),
            _namedColorToRBA(t) {
            ...
            _hslColorToRGBA(t) {
                if (/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.test(t)) {
                    ...
                    for (let t = 0; t < 3; t++)
                        (r = o + -(1 / 3 * (t - 1))) < 0 && r++,
                        r > 1 && r--,
                        n = 6 * r < 1 ? h + (e - h) * 6 * r : 2 * r < 1 ? e : 3 * r < 2 ? h + (e - h) * (2 / 3 - r) * 6 : h,
                        u[t] = 255 * n;
                    return {
                        r: Math.round(u[0]),
                        g: Math.round(u[1]),
            ...
            degToRad: t=>t * a,
            radToDeg: t=>t * o,
            _degToRad: t=>(e.Util.warn("Util._degToRad is removed. Please use public Util.degToRad instead."),
            e.Util.degToRad(t)),
            _radToDeg: t=>(e.Util.warn("Util._radToDeg is removed. Please use public Util.radToDeg instead."),
            e.Util.radToDeg(t)),
            ...
            _getProjectionToSegment(t, e, r, n, i, a) {
                ...
                if (0 == h)
                    ...
                    u < 0 ? (o = t,
                    s = e,
                    l = (t - i) * (t - i) + (e - a) * (e - a)) : u > 1 ? (o = r,
                    s = n,
                    l = (r - i) * (r - i) + (n - a) * (n - a)) : l = ((o = t + u * (r - t)) - i) * (o - i) + ((s = e + u * (n - e)) - a) * (s - a)
                }
                return [o, s, l]
            },
                ...
                return r.forEach(function(o, s) {
                    if (n || s !== r.length - 1) {
                        var l = r[(s + 1) % r.length]
                          , h = e.Util._getProjectionToSegment(o.x, o.y, l.x, l.y, t.x, t.y)
                          , u = h[0]
                          , d = h[1]
                          , c = h[2];
                        c < a && (i.x = u,
            ...
            _prepareToStringify(t) {
                var r;
                for (var n in t.visitedByCircularReferenceRemoval = !0,
                t)
                    if (t.hasOwnProperty(n) && t[n] && "object" == typeof t[n]) {
                        if (r = Object.getOwnPropertyDescriptor(t, n),
                        t[n].visitedByCircularReferenceRemoval || e.Util._isElement(t[n])) {
                            if (!r.configurable)
                                return null;
                            delete t[n]
            ...
            releaseCanvas(...t) {
                n.Konva.releaseCanvasOnDestroy && t.forEach(t=>{
                    t.width = 0,
                    t.height = 0
                }
                )
            ...
            drawRoundedRectPath(t, e, r, n) {
                let i = 0
                  ...
                  , o = 0
                  , s = 0;
                "number" == typeof n ? i = a = o = s = Math.min(n, e / 2, r / 2) : (i = Math.min(n[0] || 0, e / 2, r / 2),
    ...
    7367: function(t, e, r) {
        ...
        e.getNumberValidator = function() {
            if (n.Konva.isUnminified)
                return function(t, e) {
                    return i.Util._isNumber(t) || i.Util.warn(a(t) + ' is a not valid value for "' + e + '" attribute. The value should be a number.'),
                    t
                }
        }
        ,
        e.getNumberOrArrayOfNumbersValidator = function(t) {
            if (n.Konva.isUnminified)
                return function(e, r) {
                    ...
                    return n || o || i.Util.warn(a(e) + ' is a not valid value for "' + r + '" attribute. The value should be a number or Array<number>(' + t + ")"),
                    e
                }
        }
        ,
            ...
            if (n.Konva.isUnminified)
                return function(t, e) {
                    var r = i.Util._isNumber(t)
                      , n = "auto" === t;
                    return r || n || i.Util.warn(a(t) + ' is a not valid value for "' + e + '" attribute. The value should be a number or "auto".'),
                    t
                }
        }
        ,
        e.getStringValidator = function() {
            if (n.Konva.isUnminified)
                return function(t, e) {
                    return i.Util._isString(t) || i.Util.warn(a(t) + ' is a not valid value for "' + e + '" attribute. The value should be a string.'),
                    t
                }
        }
        ,
        e.getStringOrGradientValidator = function() {
            if (n.Konva.isUnminified)
                return function(t, e) {
                    ...
                    return r || n || i.Util.warn(a(t) + ' is a not valid value for "' + e + '" attribute. The value should be a string or a native gradient.'),
                    t
                }
        }
        ,
        e.getFunctionValidator = function() {
            if (n.Konva.isUnminified)
                return function(t, e) {
                    return i.Util._isFunction(t) || i.Util.warn(a(t) + ' is a not valid value for "' + e + '" attribute. The value should be a function.'),
                    t
                }
        }
        ,
        e.getNumberArrayValidator = function() {
            if (n.Konva.isUnminified)
                return function(t, e) {
                    ...
                    return r && t instanceof r || (i.Util._isArray(t) ? t.forEach(function(t) {
                        i.Util._isNumber(t) || i.Util.warn('"' + e + '" attribute has non numeric element ' + t + ". Make sure that all elements are numbers.")
                    }) : i.Util.warn(a(t) + ' is a not valid value for "' + e + '" attribute. The value should be a array of numbers.')),
                    t
                }
        }
        ,
        e.getBooleanValidator = function() {
            if (n.Konva.isUnminified)
                return function(t, e) {
                    return !0 === t || !1 === t || i.Util.warn(a(t) + ' is a not valid value for "' + e + '" attribute. The value should be a boolean.'),
                    t
                }
        }
        ,
        e.getComponentValidator = function(t) {
            if (n.Konva.isUnminified)
                return function(e, r) {
                    return null == e || i.Util.isObject(e) || i.Util.warn(a(e) + ' is a not valid value for "' + r + '" attribute. The value should be an object with properties ' + t),
                    e
                }
        }
    },
    ...
    375: function(t, e, r) {
        ...
        e.Blur = function(t) {
            ...
            e > 0 && function(t, e) {
                var r, n, i, a, h, u, d, c, f, g, p, v, m, y, b, _, S, x, w, C, k, P, T, F, E = t.data, N = t.width, M = t.height, A = e + e + 1, R = N - 1, D = M - 1, L = e + 1, I = L * (L + 1) / 2, G = new o, O = null, z = G, U = null, B = null, H = s[e], V = l[e];
                for (i = 1; i < A; i++)
                    z = z.next = new o,
                    i === L && (O = z);
                for (n = 0,
                ...
                d = u = 0; n < M; n++) {
                    ...
                    B = O; r < N; r++)
                        ...
                        E[u] = (c * H >> V) * T,
                        E[u + 1] = (f * H >> V) * T,
                        E[u + 2] = (g * H >> V) * T) : E[u] = E[u + 1] = E[u + 2] = 0,
                        c -= v,
                        f -= m,
                        g -= y,
                        p -= b,
                ...
                for (r = 0; r < N; r++) {
                    ...
                    B = O; n < M; n++)
                        ...
                        E[a] = (c * H >> V) * T,
                        E[a + 1] = (f * H >> V) * T,
                        E[a + 2] = (g * H >> V) * T) : E[a] = E[a + 1] = E[a + 2] = 0,
                        c -= v,
                        f -= m,
                        g -= y,
                        p -= b,
        ...
        ,
        n.Factory.addGetterSetter(i.Node, "blurRadius", 0, (0,
    ...
    6797: function(t, e, r) {
        ...
        e.Brighten = function(t) {
            var e, r = 255 * this.brightness(), n = t.data, i = n.length;
            for (e = 0; e < i; e += 4)
                n[e] += r,
                n[e + 1] += r,
                n[e + 2] += r
        ...
        ,
        n.Factory.addGetterSetter(i.Node, "brightness", 0, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    2613: function(t, e, r) {
        "use strict";
        ...
        e.Contrast = function(t) {
            var e, r = Math.pow((this.contrast() + 100) / 100, 2), n = t.data, i = n.length, a = 150, o = 150, s = 150;
            for (e = 0; e < i; e += 4)
                a = n[e],
                o = n[e + 1],
                s = n[e + 2],
        ...
        ,
        n.Factory.addGetterSetter(i.Node, "contrast", 0, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    4898: function(t, e, r) {
        "use strict";
        ...
        ,
        n.Factory.addGetterSetter(i.Node, "embossStrength", .5, (0,
        o.getNumberValidator)(), n.Factory.afterSetFilter),
        n.Factory.addGetterSetter(i.Node, "embossWhiteLevel", .5, (0,
        o.getNumberValidator)(), n.Factory.afterSetFilter),
        n.Factory.addGetterSetter(i.Node, "embossDirection", "top-left", null, n.Factory.afterSetFilter),
        n.Factory.addGetterSetter(i.Node, "embossBlend", !1, null, n.Factory.afterSetFilter)
    },
    5073: function(t, e, r) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
        ...
        e.Enhance = function(t) {
            var e, r, n, i, a, s, l, h, u, d, c, f, g, p = t.data, v = p.length, m = p[0], y = m, b = p[1], _ = b, S = p[2], x = S, w = this.enhance();
            if (0 !== w) {
                for (g = 0; g < v; g += 4)
        ...
        ,
        n.Factory.addGetterSetter(i.Node, "enhance", 0, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    5640: function(t, e) {
        "use strict";
        ...
        e.Grayscale = function(t) {
            var e, r, n = t.data, i = n.length;
            for (e = 0; e < i; e += 4)
                r = .34 * n[e] + .5 * n[e + 1] + .16 * n[e + 2],
                n[e] = r,
                n[e + 1] = r,
                n[e + 2] = r
        }
    ...
    9133: function(t, e, r) {
        ...
        let n = r(1027)
          , i = r(4667)
          , a = r(7367);
        n.Factory.addGetterSetter(i.Node, "hue", 0, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter),
        n.Factory.addGetterSetter(i.Node, "saturation", 0, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter),
        n.Factory.addGetterSetter(i.Node, "luminance", 0, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter),
        e.HSL = function(t) {
            var e, r, n, i, a, o = t.data, s = o.length, l = Math.pow(2, this.saturation()), h = Math.abs(this.hue() + 360) % 360, u = 127 * this.luminance(), d = 1 * l * Math.cos(h * Math.PI / 180), c = 1 * l * Math.sin(h * Math.PI / 180), f = .299 + .701 * d + .167 * c, g = .587 - .587 * d + .33 * c, p = .114 - .114 * d - .497 * c, v = .299 - .299 * d - .328 * c, m = .587 + .413 * d + .035 * c, y = .114 - .114 * d + .293 * c, b = .299 - .3 * d + 1.25 * c, _ = .587 - .586 * d - 1.05 * c, S = .114 + .886 * d - .2 * c;
            for (a = 0; a < s; a += 4)
                e = o[a + 0],
                r = o[a + 1],
                n = o[a + 2],
    ...
    3785: function(t, e, r) {
        ...
        n.Factory.addGetterSetter(i.Node, "saturation", 0, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter),
        n.Factory.addGetterSetter(i.Node, "value", 0, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    3123: function(t, e) {
        "use strict";
    ...
    206: function(t, e, r) {
        ...
        var s = function(t, e, r) {
            var n, i, a, o, s = t.data, l = e.data, h = t.width, u = t.height, d = r.polarCenterX || h / 2, c = r.polarCenterY || u / 2, f = 0, g = 0, p = 0, v = 0, m = Math.sqrt(d * d + c * c);
            m = (o = Math.sqrt((i = h - d) * i + (a = u - c) * a)) > m ? o : m;
            var y, b, _, S, x = 360 / h * Math.PI / 180;
            for (b = 0; b < h; b += 1)
                for (y = 0,
                _ = Math.sin(b * x),
                S = Math.cos(b * x); y < u; y += 1)
                    i = Math.floor(d + m * y / u * S),
                    f = s[(n = ((a = Math.floor(c + m * y / u * _)) * h + i) * 4) + 0],
                    g = s[n + 1],
                    p = s[n + 2],
                    v = s[n + 3],
                    l[(n = (b + y * h) * 4) + 0] = f,
          ...
          , l = function(t, e, r) {
            var n, i, a, o, s, l, h, u = t.data, d = e.data, c = t.width, f = t.height, g = r.polarCenterX || c / 2, p = r.polarCenterY || f / 2, v = 0, m = 0, y = 0, b = 0, _ = Math.sqrt(g * g + p * p);
            _ = (h = Math.sqrt((a = c - g) * a + (o = f - p) * o)) > _ ? h : _;
            var S, x = r.polarRotation || 0;
            for (a = 0; a < c; a += 1)
                for (o = 0; o < f; o += 1)
                    S = Math.sqrt((s = a - g) * s + (l = o - p) * l) * f / _,
                    n = Math.floor((180 * Math.atan2(l, s) / Math.PI + 360 + x) % 360 * c / 360),
        ...
        e.Kaleidoscope = function(t) {
            var e, r, n, i, o, h, u, d, c, f, g = t.width, p = t.height, v = Math.round(this.kaleidoscopePower()), m = Math.floor(Math.round(this.kaleidoscopeAngle()) % 360 * g / 360);
            if (!(v < 1)) {
        ...
        ,
        n.Factory.addGetterSetter(i.Node, "kaleidoscopePower", 2, (0,
        o.getNumberValidator)(), n.Factory.afterSetFilter),
        n.Factory.addGetterSetter(i.Node, "kaleidoscopeAngle", 0, (0,
        o.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    8962: function(t, e, r) {
        "use strict";
        ...
        function o(t, e, r) {
            var n = (r * t.width + e) * 4
              , i = [];
            return i.push(t.data[n++], t.data[n++], t.data[n++], t.data[n++]),
            i
        }
        function s(t, e) {
        ...
        e.Mask = function(t) {
            var e = function(t, e) {
                ...
                if (s(r, n) < l && s(n, a) < l && s(a, i) < l && s(i, r) < l) {
                    for (var h = function(t) {
                        ...
                        e[2] /= t.length,
                        e
                    }([n, r, a, i]), u = [], d = 0; d < t.width * t.height; d++) {
                        var c = s(h, [t.data[4 * d], t.data[4 * d + 1], t.data[4 * d + 2]]);
                        u[d] = c < l ? 0 : 255
                    }
                    return u
                }
            ...
            return e && (e = function(t, e, r) {
                for (var n = [1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9], i = Math.round(Math.sqrt(n.length)), a = Math.floor(i / 2), o = [], s = 0; s < r; s++)
                    for (var l = 0; l < e; l++) {
                ...
                for (var n = [1, 1, 1, 1, 1, 1, 1, 1, 1], i = Math.round(Math.sqrt(n.length)), a = Math.floor(i / 2), o = [], s = 0; s < r; s++)
                    for (var l = 0; l < e; l++) {
                        for (var h = s * e + l, u = 0, d = 0; d < i; d++)
                            for (var c = 0; c < i; c++) {
                                var f = s + d - a
                ...
                for (var n = [1, 1, 1, 1, 0, 1, 1, 1, 1], i = Math.round(Math.sqrt(n.length)), a = Math.floor(i / 2), o = [], s = 0; s < r; s++)
                    for (var l = 0; l < e; l++) {
                        for (var h = s * e + l, u = 0, d = 0; d < i; d++)
                            for (var c = 0; c < i; c++) {
                                var f = s + d - a
        ...
        ,
        n.Factory.addGetterSetter(i.Node, "threshold", 0, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    6990: function(t, e, r) {
        "use strict";
        ...
        let n = r(1027)
          ...
          , a = r(7367);
        e.Noise = function(t) {
            var e, r = 255 * this.noise(), n = t.data, i = n.length, a = r / 2;
            for (e = 0; e < i; e += 4)
        ...
        ,
        n.Factory.addGetterSetter(i.Node, "noise", .2, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    5812: function(t, e, r) {
        "use strict";
        ...
        e.Pixelate = function(t) {
            var e, r, n, a, o, s, l, h, u, d, c, f, g, p, v = Math.ceil(this.pixelSize()), m = t.width, y = t.height, b = Math.ceil(m / v), _ = Math.ceil(y / v), S = t.data;
            if (v <= 0) {
        ...
        ,
        n.Factory.addGetterSetter(a.Node, "pixelSize", 8, (0,
        o.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    7142: function(t, e, r) {
        "use strict";
        ...
        e.Posterize = function(t) {
            var e, r = Math.round(254 * this.levels()) + 1, n = t.data, i = n.length, a = 255 / r;
            for (e = 0; e < i; e += 1)
                n[e] = Math.floor(n[e] / a) * a
        }
        ,
        n.Factory.addGetterSetter(i.Node, "levels", .5, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    6497: function(t, e, r) {
        "use strict";
        ...
        let n = r(1027)
          ...
          , a = r(7367);
        e.RGB = function(t) {
            var e, r, n = t.data, i = n.length, a = this.red(), o = this.green(), s = this.blue();
            for (e = 0; e < i; e += 4)
                r = (.34 * n[e] + .5 * n[e + 1] + .16 * n[e + 2]) / 255,
                n[e] = r * a,
                n[e + 1] = r * o,
                n[e + 2] = r * s,
                n[e + 3] = n[e + 3]
        ...
        n.Factory.addGetterSetter(i.Node, "blue", 0, a.RGBComponent, n.Factory.afterSetFilter)
    },
    5492: function(t, e, r) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
        ...
        let n = r(1027)
          ...
          , a = r(7367);
        e.RGBA = function(t) {
            var e, r, n = t.data, i = n.length, a = this.red(), o = this.green(), s = this.blue(), l = this.alpha();
            for (e = 0; e < i; e += 4)
                r = 1 - l,
                n[e] = a * l + n[e] * r,
                n[e + 1] = o * l + n[e + 1] * r,
    ...
    3186: function(t, e) {
        ...
        e.Sepia = void 0,
        e.Sepia = function(t) {
            var e, r, n, i, a = t.data, o = a.length;
            for (e = 0; e < o; e += 4)
                r = a[e + 0],
                n = a[e + 1],
                i = a[e + 2],
                a[e + 0] = Math.min(255, .393 * r + .769 * n + .189 * i),
                a[e + 1] = Math.min(255, .349 * r + .686 * n + .168 * i),
                a[e + 2] = Math.min(255, .272 * r + .534 * n + .131 * i)
        }
    },
    5639: function(t, e) {
        "use strict";
    ...
    1940: function(t, e, r) {
        ...
        e.Threshold = function(t) {
            var e, r = 255 * this.threshold(), n = t.data, i = n.length;
            for (e = 0; e < i; e += 1)
                n[e] = n[e] < r ? 0 : 255
        }
        ,
        n.Factory.addGetterSetter(i.Node, "threshold", .5, (0,
        a.getNumberValidator)(), n.Factory.afterSetFilter)
    },
    1235: function(t, e, r) {
        "use strict";
    ...
    121: function(t, e, r) {
        ...
        (0,
        s._registerNode)(l),
        n.Factory.addGetterSetter(l, "innerRadius", 0, (0,
        o.getNumberValidator)()),
        n.Factory.addGetterSetter(l, "outerRadius", 0, (0,
        o.getNumberValidator)()),
        n.Factory.addGetterSetter(l, "angle", 0, (0,
        o.getNumberValidator)()),
        n.Factory.addGetterSetter(l, "clockwise", !1, (0,
    ...
    7270: function(t, e, r) {
        ...
        class l extends i.Line {
            _sceneFunc(t) {
                super._sceneFunc(t);
                var e, r, n = 2 * Math.PI, i = this.points(), a = i, o = 0 !== this.tension() && i.length > 4;
                o && (a = this.getTensionPoints());
                var l = this.pointerLength()
                  , h = i.length;
                if (o) {
                    let t = [a[a.length - 4], a[a.length - 3], a[a.length - 2], a[a.length - 1], i[h - 2], i[h - 1]]
                      , n = s.Path.calcLength(a[a.length - 4], a[a.length - 3], "C", t)
                      , o = s.Path.getPointOnQuadraticBezier(Math.min(1, 1 - l / n), t[0], t[1], t[2], t[3], t[4], t[5]);
                    e = i[h - 2] - o.x,
                    r = i[h - 1] - o.y
                } else
                    e = i[h - 2] - i[h - 4],
        ...
        (0,
        o._registerNode)(l),
        n.Factory.addGetterSetter(l, "pointerLength", 10, (0,
        a.getNumberValidator)()),
        n.Factory.addGetterSetter(l, "pointerWidth", 10, (0,
        a.getNumberValidator)()),
    ...
    7184: function(t, e, r) {
        ...
        (0,
        o._registerNode)(s),
        n.Factory.addGetterSetter(s, "radius", 0, (0,
        a.getNumberValidator)())
    },
    2689: function(t, e, r) {
        "use strict";
        ...
        n.Factory.addGetterSetter(s, "radiusX", 0, (0,
        a.getNumberValidator)()),
        n.Factory.addGetterSetter(s, "radiusY", 0, (0,
        a.getNumberValidator)())
    },
    4582: function(t, e, r) {
        "use strict";
        ...
        class l extends a.Shape {
            ...
            _sceneFunc(t) {
                ...
                if (o) {
                    ...
                    e = t && n ? [o, this.cropX(), this.cropY(), t, n, 0, 0, r, i] : [o, 0, 0, r, i]
                }
                (this.hasFill() || this.hasStroke() || a) && (t.beginPath(),
                a ? n.Util.drawRoundedRectPath(t, r, i, a) : t.rect(0, 0, r, i),
                t.closePath(),
                t.fillStrokeShape(this)),
                o && (a && t.clip(),
                t.drawImage.apply(t, e))
            }
            _hitFunc(t) {
                var e = this.width()
                  , r = this.height()
        ...
        (0,
        o._registerNode)(l),
        i.Factory.addGetterSetter(l, "cornerRadius", 0, (0,
        s.getNumberOrArrayOfNumbersValidator)(4)),
        i.Factory.addGetterSetter(l, "image"),
        i.Factory.addComponentsGetterSetter(l, "crop", ["x", "y", "width", "height"]),
        i.Factory.addGetterSetter(l, "cropX", 0, (0,
        s.getNumberValidator)()),
        i.Factory.addGetterSetter(l, "cropY", 0, (0,
        s.getNumberValidator)()),
        i.Factory.addGetterSetter(l, "cropWidth", 0, (0,
        s.getNumberValidator)()),
        i.Factory.addGetterSetter(l, "cropHeight", 0, (0,
        s.getNumberValidator)())
    },
    6218: function(t, e, r) {
        "use strict";
        ...
        let n = r(1027)
          ...
          , o = r(7367)
          , s = r(9649);
        var l = ["fontFamily", "fontSize", "fontStyle", "padding", "lineHeight", "text", "width", "height", "pointerDirection", "pointerWidth", "pointerHeight"]
          , h = "right"
          , u = "down"
          , d = "left"
          , c = l.length;
        class f extends a.Group {
            ...
            _sync() {
                var t, e, r, n, i, a, o, s = this.getText(), l = this.getTag();
                if (s && l) {
                    switch (t = s.width(),
                    e = s.height(),
        ...
        n.Factory.addGetterSetter(g, "pointerWidth", 0, (0,
        o.getNumberValidator)()),
        n.Factory.addGetterSetter(g, "pointerHeight", 0, (0,
        o.getNumberValidator)()),
        n.Factory.addGetterSetter(g, "cornerRadius", 0, (0,
        o.getNumberOrArrayOfNumbersValidator)(4))
    },
    64: function(t, e, r) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
        ...
        function s(t, e, r, n, i, a, o) {
            var s = Math.sqrt(Math.pow(r - t, 2) + Math.pow(n - e, 2))
              ...
              , h = o * s / (s + l)
              , u = o * l / (s + l);
            return [r - h * (i - t), n - h * (a - e), r + u * (i - t), n + u * (a - e)]
        }
        function l(t, e) {
            var r, n, i = t.length, a = [];
            for (r = 2; r < i - 2; r += 2)
                isNaN((n = s(t[r - 2], t[r - 1], t[r], t[r + 1], t[r + 2], t[r + 3], e))[0]) || (a.push(n[0]),
                a.push(n[1]),
                a.push(t[r]),
                a.push(t[r + 1]),
                a.push(n[2]),
        ...
        class h extends i.Shape {
            ...
            _sceneFunc(t) {
                var e, r, n, i = this.points(), a = i.length, o = this.tension(), s = this.closed(), l = this.bezier();
                if (a) {
                    if (t.beginPath(),
                    t.moveTo(i[0], i[1]),
                    0 !== o && a > 4) {
                        for (r = (e = this.getTensionPoints()).length,
                        n = s ? 0 : 4,
                        s || t.quadraticCurveTo(e[0], e[1], e[2], e[3]); n < r - 2; )
            ...
            _getTensionPointsClosed() {
                var t = this.points()
                  ...
                  , a = l(t, r);
                return [n[2], n[3]].concat(a).concat([i[0], i[1], t[e - 2], t[e - 1], i[2], i[3], n[0], n[1], t[0], t[1]])
            }
            getWidth() {
            ...
            getSelfRect() {
                ...
                for (var n = (r = 0 !== this.tension() ? [r[0], r[1], ...this._getTensionPoints(), r[r.length - 2], r[r.length - 1]] : this.points())[0], i = r[0], a = r[1], o = r[1], s = 0; s < r.length / 2; s++)
                    t = r[2 * s],
                    e = r[2 * s + 1],
                    n = Math.min(n, t),
                    i = Math.max(i, t),
        ...
        n.Factory.addGetterSetter(h, "tension", 0, (0,
        a.getNumberValidator)()),
        n.Factory.addGetterSetter(h, "points", [], (0,
        a.getNumberArrayValidator)())
    },
    7771: function(t, e, r) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
        ...
        class s extends i.Shape {
                ...
                this.dataArray.forEach(function(t) {
                    if ("A" === t.command) {
                        var e = t.points[4]
                          ...
                          , i = t.points[4] + n
                          , a = Math.PI / 180;
                        if (Math.abs(e - i) < a && (a = Math.abs(e - i)),
                        n < 0)
                            for (let n = e - a; n > i; n -= a) {
                                let e = s.getPointOnEllipticalArc(t.points[0], t.points[1], t.points[2], t.points[3], n, 0);
                                r.push(e.x, e.y)
                            }
                        else
                            for (let n = e + a; n < i; n += a) {
                        ...
                        for (let e = 0; e <= 1; e += .01) {
                            let n = s.getPointOnCubicBezier(e, t.start.x, t.start.y, t.points[0], t.points[1], t.points[2], t.points[3], t.points[4], t.points[5]);
                            r.push(n.x, n.y)
                        }
                    else
                        r = r.concat(t.points)
                });
                for (var n = r[0], i = r[0], a = r[1], o = r[1], l = 0; l < r.length / 2; l++)
                    t = r[2 * l],
                    e = r[2 * l + 1],
                    isNaN(t) || (n = Math.min(n, t),
                    i = Math.max(i, t)),
                    isNaN(e) || (a = Math.min(a, e),
                    o = Math.max(o, e));
                return {
                    x: n,
                    y: a,
            ...
            static getPointAtLengthOfDataArray(t, e) {
                ...
                case "C":
                    return s.getPointOnCubicBezier((0,
                    o.t2length)(t, s.getPathLength(e), t=>(0,
                    o.getCubicArcLength)([a.start.x, l[0], l[2], l[4]], [a.start.y, l[1], l[3], l[5]], t)), a.start.x, a.start.y, l[0], l[1], l[2], l[3], l[4], l[5]);
                case "Q":
                    return s.getPointOnQuadraticBezier((0,
                    o.t2length)(t, s.getPathLength(e), t=>(0,
                    o.getQuadraticArcLength)([a.start.x, l[0], l[2]], [a.start.y, l[1], l[3]], t)), a.start.x, a.start.y, l[0], l[1], l[2], l[3]);
                case "A":
                    var h = l[0]
                      , u = l[1]
                      , d = l[2]
            ...
            static getPointOnLine(t, e, r, n, i, a, o) {
                ...
                else if ((o - r) / (a - e + 1e-8) === s)
                    u = {
                        x: a + l,
                        y: o + h
                    };
                else {
                    var u, d, c, f = this.getLineLength(e, r, n, i), g = (a - e) * (n - e) + (o - r) * (i - r);
                    g /= f * f,
                    d = e + g * (n - e),
                    c = r + g * (i - r);
                    var p = this.getLineLength(a, o, d, c)
                      , v = Math.sqrt(t * t - p * p);
                    l = Math.sqrt(v * v / (1 + s * s)),
                    n < e && (l *= -1),
                    h = s * l,
                    u = {
                        x: d + l,
            ...
            static getPointOnCubicBezier(t, e, r, n, i, a, o, s, l) {
                ...
                return {
                    x: t * t * t * s + 3 * t * t * (1 - t) * a + n * h(t) + (1 - t) * (1 - t) * (1 - t) * e,
                    y: t * t * t * l + 3 * t * t * (1 - t) * o + i * h(t) + (1 - t) * (1 - t) * (1 - t) * r
                }
            }
            ...
            static parsePathData(t) {
                if (!t)
                    return [];
                var e = t
                  , r = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"];
                ...
                for (n = 1; n < i.length; n++) {
                    ...
                    for (; c.length > 0 && !isNaN(c[0]); ) {
                        var v, m, y, b, _, S, x, w, C, k, P, T = "", F = [], E = s, N = l;
                        switch (d) {
                        case "l":
                            s += c.shift(),
                            l += c.shift(),
                        ...
                        case "V":
                            ...
                            break;
                        case "C":
                            F.push(c.shift(), c.shift(), c.shift(), c.shift()),
                            s = c.shift(),
                            l = c.shift(),
                            F.push(s, l);
                            break;
                        case "c":
                            F.push(s + c.shift(), l + c.shift(), s + c.shift(), l + c.shift()),
                            s += c.shift(),
                            l += c.shift(),
                            T = "C",
                            F.push(s, l);
                        ...
                        case "S":
                            y = s,
                            b = l,
                            "C" === (m = a[a.length - 1]).command && (y = s + (s - m.points[2]),
                            b = l + (l - m.points[3])),
                            F.push(y, b, c.shift(), c.shift()),
                            s = c.shift(),
                            l = c.shift(),
                            T = "C",
                            F.push(s, l);
                        ...
                        case "s":
                            ...
                            "C" === (m = a[a.length - 1]).command && (y = s + (s - m.points[2]),
                            b = l + (l - m.points[3])),
                            F.push(y, b, s + c.shift(), l + c.shift()),
                            s += c.shift(),
                            l += c.shift(),
                            T = "C",
                            F.push(s, l);
                            break;
                        case "Q":
                            F.push(c.shift(), c.shift()),
                            s = c.shift(),
                            l = c.shift(),
                            F.push(s, l);
                            break;
                        case "q":
                            F.push(s + c.shift(), l + c.shift()),
                            s += c.shift(),
                            l += c.shift(),
                            T = "Q",
                            F.push(s, l);
                        ...
                        case "T":
                            y = s,
                            b = l,
                            "Q" === (m = a[a.length - 1]).command && (y = s + (s - m.points[0]),
                            b = l + (l - m.points[1])),
                            s = c.shift(),
                            l = c.shift(),
                            T = "Q",
                        ...
                        case "A":
                            ...
                            l = c.shift(),
                            T = "A",
                            F = this.convertEndpointToCenterParameterization(k, P, s, l, w, C, _, S, x);
                            break;
                        case "a":
                            _ = c.shift(),
                            S = c.shift(),
                        ...
                        a.push({
                            ...
                            pathLength: this.calcLength(E, N, T || d, F)
                        })
                    }
                    ("z" === d || "Z" === d) && a.push({
                        command: "z",
            ...
            static calcLength(t, e, r, n) {
                ...
                case "C":
                    return (0,
                    o.getCubicArcLength)([t, n[0], n[2], n[4]], [e, n[1], n[3], n[5]], 1);
                case "Q":
                    return (0,
                    o.getQuadraticArcLength)([t, n[0], n[2]], [e, n[1], n[3]], 1);
                case "A":
                    i = 0;
                    var u = n[4]
                      , d = n[5]
                      , c = n[4] + d
                      , f = Math.PI / 180;
                    if (Math.abs(u - c) < f && (f = Math.abs(u - c)),
                    ...
                    d < 0)
                        ...
                        for (h = u + f; h < c; h += f)
                            ...
                            i += s.getLineLength(a.x, a.y, l.x, l.y),
                            a = l;
                    return l = s.getPointOnEllipticalArc(n[0], n[1], n[2], n[3], c, 0),
                    i += s.getLineLength(a.x, a.y, l.x, l.y)
                }
                return 0
            }
            static convertEndpointToCenterParameterization(t, e, r, n, i, a, o, s, l) {
                var h = Math.PI / 180 * l
                ...
                c > 1 && (o *= Math.sqrt(c),
                s *= Math.sqrt(c));
                var f = Math.sqrt((o * o * (s * s) - o * o * (d * d) - s * s * (u * u)) / (o * o * (d * d) + s * s * (u * u)));
                i === a && (f *= -1),
                isNaN(f) && (f = 0);
                var g = f * o * d / s
                  , p = -(f * s) * u / o
                  ...
                  , S = [(-1 * u - g) / o, (-1 * d - p) / s]
                  , x = y(_, S);
                return -1 >= m(_, S) && (x = Math.PI),
                m(_, S) >= 1 && (x = 0),
                0 === a && x > 0 && (x -= 2 * Math.PI),
                1 === a && x < 0 && (x += 2 * Math.PI),
                [(t + r) / 2 + Math.cos(h) * g - Math.sin(h) * p, (e + n) / 2 + Math.sin(h) * g + Math.cos(h) * p, o, s, b, x, h, a]
            }
        }
        e.Path = s,
    ...
    8294: function(t, e, r) {
        ...
        (0,
        a._registerNode)(l),
        n.Factory.addGetterSetter(l, "cornerRadius", 0, (0,
        s.getNumberOrArrayOfNumbersValidator)(4))
    },
    9870: function(t, e, r) {
        "use strict";
        ...
        n.Factory.addGetterSetter(s, "radius", 0, (0,
        a.getNumberValidator)()),
        n.Factory.addGetterSetter(s, "sides", 0, (0,
        a.getNumberValidator)())
    },
    7827: function(t, e, r) {
        "use strict";
    ...
    706: function(t, e, r) {
        ...
        n.Factory.addGetterSetter(l, "frameIndex", 0, (0,
        o.getNumberValidator)()),
        n.Factory.addGetterSetter(l, "frameRate", 17, (0,
        o.getNumberValidator)()),
    ...
    3371: function(t, e, r) {
        ...
        (0,
        o._registerNode)(s),
        n.Factory.addGetterSetter(s, "numPoints", 5, (0,
        a.getNumberValidator)()),
        n.Factory.addGetterSetter(s, "innerRadius", 0, (0,
        a.getNumberValidator)()),
        n.Factory.addGetterSetter(s, "outerRadius", 0, (0,
        a.getNumberValidator)())
    },
    1588: function(t, e, r) {
        "use strict";
        ...
        e.stringToArray = l;
        var h, u = "auto", d = "inherit", c = "justify", f = "left", g = "middle", p = "normal", v = "none", m = ["direction", "fontFamily", "fontSize", "fontStyle", "fontVariant", "padding", "align", "verticalAlign", "lineHeight", "text", "width", "height", "wrap", "ellipsis", "letterSpacing"], y = m.length;
        function b() {
            return h || (h = n.Util.createCanvasElement().getContext("2d"))
        }
        class _ extends a.Shape {
            constructor(t) {
                var e;
                super(((e = (e = t) || {}).fillLinearGradientColorStops || e.fillRadialGradientColorStops || e.fillPatternImage || (e.fill = e.fill || "black"),
                e)),
                this._partialTextX = 0,
                this._partialTextY = 0;
                for (var r = 0; r < y; r++)
                    this.on(m[r] + "Change.konva", this._setTextData);
                this._setTextData()
            }
            _sceneFunc(t) {
                var e = this.textArr
                  , r = e.length;
                if (this.text()) {
                    var n, i = this.padding(), a = this.fontSize(), o = this.lineHeight() * a, s = this.verticalAlign(), h = this.direction(), u = 0, p = this.align(), v = this.getWidth(), m = this.letterSpacing(), y = this.fill(), b = this.textDecoration(), _ = -1 !== b.indexOf("underline"), S = -1 !== b.indexOf("line-through");
                    h = h === d ? t.direction : h;
                    var x = o / 2
                      , w = 0
                      , C = 0;
                    for ("rtl" === h && t.setAttr("direction", h),
                    t.setAttr("font", this._getContextFont()),
                    t.setAttr("textBaseline", g),
                    t.setAttr("textAlign", f),
                    s === g ? u = (this.getHeight() - r * o - 2 * i) / 2 : "bottom" === s && (u = this.getHeight() - r * o - 2 * i),
                    t.translate(i, u + i),
                    n = 0; n < r; n++) {
                        var k, P, T, w = 0, C = 0, F = e[n], E = F.text, N = F.width, M = F.lastInParagraph;
                        if (t.save(),
                        "right" === p ? w += v - N - 2 * i : "center" === p && (w += (v - N - 2 * i) / 2),
                        _) {
                            t.save(),
                            t.beginPath(),
                            t.moveTo(w, x + C + Math.round(a / 2)),
                            P = 0 == (k = E.split(" ").length - 1),
                            T = p !== c || M ? N : v - 2 * i,
                            t.lineTo(w + Math.round(T), x + C + Math.round(a / 2)),
                            t.lineWidth = a / 15;
                            let e = this._getLinearGradient();
                            t.strokeStyle = e || y,
                            t.stroke(),
                            t.restore()
                        }
                        ...
                        if ("rtl" !== h && (0 !== m || p === c)) {
                            k = E.split(" ").length - 1;
                            for (var A = l(E), R = 0; R < A.length; R++) {
                                var D = A[R];
                                " " !== D || M || p !== c || (w += (v - 2 * i - N) / k),
                                this._partialTextX = w,
                                this._partialTextY = x + C,
                                this._partialText = D,
                                t.fillStrokeShape(this),
                                w += this.measureSize(D).width + m
                            }
                        } else
                            0 !== m && t.setAttr("letterSpacing", `${m}px`),
                            this._partialTextX = w,
                            this._partialTextY = x + C,
                            this._partialText = E,
                            t.fillStrokeShape(this);
            ...
            getWidth() {
                return this.attrs.width === u || void 0 === this.attrs.width ? this.getTextWidth() + 2 * this.padding() : this.attrs.width
            }
            getHeight() {
                return this.attrs.height === u || void 0 === this.attrs.height ? this.fontSize() * this.textArr.length * this.lineHeight() + 2 * this.padding() : this.attrs.height
            }
            getTextWidth() {
                return this.textWidth
            }
            getTextHeight() {
                return n.Util.warn("text.getTextHeight() method is deprecated. Use text.height() - for full height and text.fontSize() - for one line height."),
                this.textHeight
            }
            measureSize(t) {
                var e, r = b(), n = this.fontSize();
                return r.save(),
                r.font = this._getContextFont(),
                e = r.measureText(t),
                r.restore(),
                {
                    width: e.width,
            ...
            _getTextWidth(t) {
                var e = this.letterSpacing()
                  , r = t.length;
                return b().measureText(t).width + (r ? e * (r - 1) : 0)
            }
            _setTextData() {
                ...
                for (var m = p ? this._getTextWidth("…") : 0, y = 0, _ = t.length; y < _; ++y) {
                    var S = t[y]
                    ...
                    if (o && x > h)
                        for (; S.length > 0; ) {
                            ...
                            if (k) {
                                if (g) {
                                    var N, M = S[k.length];
                                    (N = (" " === M || "-" === M) && P <= h ? k.length : Math.max(k.lastIndexOf(" "), k.lastIndexOf("-")) + 1) > 0 && (w = N,
                                    k = k.slice(0, w),
                                ...
                                if ((S = (S = S.slice(w)).trimLeft()).length > 0 && (x = this._getTextWidth(S)) <= h) {
                                    this._addTextLine(S),
                                    c += n,
                                    r = Math.max(r, x);
                                    break
                        ...
                        c += n,
                        r = Math.max(r, x),
                        this._shouldHandleEllipsis(c) && y < _ - 1 && this._tryToAddEllipsisToLastLine();
            ...
            _shouldHandleEllipsis(t) {
                var e = +this.fontSize()
                  ...
                  , n = this.attrs.height
                  , i = this.padding();
                return !(this.wrap() !== v) || n !== u && void 0 !== n && t + r > n - 2 * i
            }
            _tryToAddEllipsisToLastLine() {
                ...
                n && r && (t === u || void 0 === t || this._getTextWidth(n.text + "…") < t - 2 * e || (n.text = n.text.slice(0, n.text.length - 3)),
            ...
            _useBufferCanvas() {
                let t = -1 !== this.textDecoration().indexOf("underline") || -1 !== this.textDecoration().indexOf("line-through")
                  , e = this.hasShadow();
                return !!t && !!e || super._useBufferCanvas()
            }
        }
        e.Text = _,
        _.prototype._fillFunc = function(t) {
            t.fillText(this._partialText, this._partialTextX, this._partialTextY)
        }
        ,
        _.prototype._strokeFunc = function(t) {
            t.setAttr("miterLimit", 2),
            t.strokeText(this._partialText, this._partialTextX, this._partialTextY)
        }
        ,
        _.prototype.className = "Text",
        _.prototype._attrsAffectingSize = ["text", "fontSize", "padding", "wrap", "lineHeight", "letterSpacing"],
        (0,
        s._registerNode)(_),
        i.Factory.overWriteSetter(_, "width", (0,
        o.getNumberOrAutoValidator)()),
        i.Factory.overWriteSetter(_, "height", (0,
        o.getNumberOrAutoValidator)()),
        i.Factory.addGetterSetter(_, "direction", d),
        i.Factory.addGetterSetter(_, "fontFamily", "Arial"),
        i.Factory.addGetterSetter(_, "fontSize", 12, (0,
        o.getNumberValidator)()),
        i.Factory.addGetterSetter(_, "fontStyle", p),
        i.Factory.addGetterSetter(_, "fontVariant", p),
        i.Factory.addGetterSetter(_, "padding", 0, (0,
        o.getNumberValidator)()),
        i.Factory.addGetterSetter(_, "align", f),
        i.Factory.addGetterSetter(_, "verticalAlign", "top"),
        i.Factory.addGetterSetter(_, "lineHeight", 1, (0,
        o.getNumberValidator)()),
        i.Factory.addGetterSetter(_, "wrap", "word"),
        i.Factory.addGetterSetter(_, "ellipsis", !1, (0,
        o.getBooleanValidator)()),
        i.Factory.addGetterSetter(_, "letterSpacing", 0, (0,
        o.getNumberValidator)()),
        i.Factory.addGetterSetter(_, "text", "", (0,
        o.getStringValidator)()),
        i.Factory.addGetterSetter(_, "textDecoration", "")
    },
    1735: function(t, e, r) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
        ...
        class f extends a.Shape {
            ...
            _getPointAtLength(t) {
                return !this.attrs.data || t - 1 > this.pathLength ? null : o.Path.getPointAtLengthOfDataArray(t, this.dataArray)
            }
            _readDataAttribute() {
            ...
            getSelfRect() {
                ...
                for (var n = r[0] || 0, i = r[0] || 0, a = r[1] || 0, o = r[1] || 0, s = 0; s < r.length / 2; s++)
                    t = r[2 * s],
                    e = r[2 * s + 1],
                    n = Math.min(n, t),
                    i = Math.max(i, t),
            ...
            destroy() {
                return n.Util.releaseCanvas(this.dummyCanvas),
                super.destroy()
            }
        }
        e.TextPath = f,
        ...
        i.Factory.addGetterSetter(f, "fontSize", 12, (0,
        l.getNumberValidator)()),
        i.Factory.addGetterSetter(f, "fontStyle", u),
        i.Factory.addGetterSetter(f, "align", "left"),
        i.Factory.addGetterSetter(f, "letterSpacing", 0, (0,
        l.getNumberValidator)()),
    ...
    6740: function(t, e, r) {
        ...
        class S extends l.Group {
            ...
            setNode(t) {
                return n.Util.warn("tr.setNode(shape), tr.node(shape) and tr.attachTo(shape) methods are deprecated. Please use tr.nodes(nodesArray) instead."),
                this.setNodes([t])
            }
            getNode() {
            ...
            setNodes(t=[]) {
                ...
                let e = t.filter(t=>!t.isAncestorOf(this) || (n.Util.error("Konva.Transformer cannot be an a child of the node you are trying to attach"),
                !1));
                ...
                this._nodes.forEach(t=>{
                    let e = ()=>{
                      ...
                      , r = t._attrsAffectingSize.map(t=>t + "Change." + this._getEventNamespace()).join(" ");
                    t.on(r, e),
                    t.on(p.map(t=>t + `.${this._getEventNamespace()}`).join(" "), e),
            ...
            _proxyDrag(t) {
                ...
                t.on(`dragstart.${this._getEventNamespace()}`, r=>{
                    ...
                    this.isDragging() || t === this.findOne(".back") || this.startDrag(r, !1)
                }
                ),
            ...
            __getNodeShape(t, e=this.rotation(), r) {
                ...
                let l = (h.Konva.getAngle(t.getAbsoluteRotation()) + 2 * Math.PI) % (2 * Math.PI);
                return b({
            ...
            _createAnchor(t) {
                ...
                e.on("mouseenter", ()=>{
                    var r = function(t, e, r) {
                        ...
                        if (n.Util._inRange(i, 337.5, 360) || n.Util._inRange(i, 0, 22.5))
                            return "ns-resize";
                        if (n.Util._inRange(i, 22.5, 67.5))
                            return "nesw-resize";
                        if (n.Util._inRange(i, 67.5, 112.5))
                            return "ew-resize";
                        if (n.Util._inRange(i, 112.5, 157.5))
                            return "nwse-resize";
                        if (n.Util._inRange(i, 157.5, 202.5))
                            return "ns-resize";
                        if (n.Util._inRange(i, 202.5, 247.5))
                            return "nesw-resize";
                        if (n.Util._inRange(i, 247.5, 292.5))
                            return "ew-resize";
                        else if (n.Util._inRange(i, 292.5, 337.5))
                            return "nwse-resize";
                        else
                            return n.Util.error("Transformer has unknown angle for cursor detection: " + i),
                            "pointer"
                    }(t, h.Konva.getAngle(this.rotation()), this.rotateAnchorCursor());
            ...
            _createBack() {
                var t = new o.Shape({
                    ...
                    sceneFunc(t, e) {
                        ...
                        r.rotateEnabled() && r.rotateLineVisible() && t.lineTo(e.width() / 2, -r.rotateAnchorOffset() * n.Util._sign(e.height()) - i),
                        t.fillStrokeShape(e)
                    },
                    hitFunc: (t,e)=>{
            ...
            _handleMouseMove(t) {
                var e, r, n, i, a = this.findOne("." + this._movingAnchorName), o = a.getStage();
                o.setPointersPositions(t);
                ...
                this.anchorDragBoundFunc() && (l = this.anchorDragBoundFunc()(u, l, t)),
                ...
                if (u.x !== d.x || u.y !== d.y) {
                    ...
                    i = "inverted" === f ? this.keepRatio() && !t.shiftKey : "none" === f ? this.keepRatio() : this.keepRatio() || t.shiftKey;
                    ...
                    if ("top-left" === this._movingAnchorName) {
                        if (i) {
                            ...
                            n = Math.sqrt(Math.pow(p.x - a.x(), 2) + Math.pow(p.y - a.y(), 2));
                        ...
                        if (i) {
                            ...
                            n = Math.sqrt(Math.pow(a.x() - p.x, 2) + Math.pow(p.y - a.y(), 2));
                        ...
                        if (i) {
                            ...
                            n = Math.sqrt(Math.pow(p.x - a.x(), 2) + Math.pow(a.y() - p.y, 2));
                            var v = p.x < a.x() ? -1 : 1
                              , m = a.y() < p.y ? -1 : 1;
                            e = n * this.cos * v,
                            r = n * this.sin * m,
                        ...
                        if (i) {
                            ...
                            n = Math.sqrt(Math.pow(a.x() - p.x, 2) + Math.pow(a.y() - p.y, 2));
                        ...
                        console.error(Error("Wrong position argument of selection resizer: " + this._movingAnchorName));
                    var g = this.centeredScaling() || t.altKey;
                    if (g) {
                    ...
                    e = P.x,
                    r = P.y;
                    var T = this.findOne(".bottom-right").x() - this.findOne(".top-left").x()
                      , F = this.findOne(".bottom-right").y() - this.findOne(".top-left").y();
                    this._fitNodesInto({
                        x: e,
                        y: r,
                        width: T,
            ...
            _removeEvents(t) {
                ...
                if (this._transforming) {
                    ...
                    r && this._nodes.forEach(e=>{
                        var r;
                        e._fire("transformend", {
                            evt: t,
                            target: e
                        }),
                        null === (r = e.getLayer()) || void 0 === r || r.batchDraw()
                    }
                    ),
                    this._movingAnchorName = null
                }
            ...
            _fitNodesInto(t, e) {
                ...
                if (n.Util._inRange(t.width, -(2 * this.padding()) - 1, 1) || n.Util._inRange(t.height, -(2 * this.padding()) - 1, 1)) {
                    this.update();
                    return
                }
                var i = new n.Transform;
                if (i.rotate(h.Konva.getAngle(this.rotation())),
                ...
                if (this.boundBoxFunc()) {
                    ...
                    e ? t = e : n.Util.warn("boundBoxFunc returned falsy. You should return new bound rect from it!")
                }
                ...
                let o = new n.Transform
                  , s = t.width / 1e7
                  , l = t.height / 1e7;
                !1 === this.flipEnabled() ? (o.translate(t.x, t.y),
                o.rotate(t.rotation),
                o.translate(t.width < 0 ? t.width : 0, t.height < 0 ? t.height : 0),
                o.scale(Math.abs(s), Math.abs(l))) : (o.translate(t.x, t.y),
                o.rotate(t.rotation),
                o.scale(s, l));
        ...
        i.Factory.addGetterSetter(S, "enabledAnchors", y, function(t) {
            return t instanceof Array || n.Util.warn("enabledAnchors value should be an array"),
            t instanceof Array && t.forEach(function(t) {
                -1 === y.indexOf(t) && n.Util.warn("Unknown anchor name: " + t + ". Available names are: " + y.join(", "))
            }),
            t || []
        }),
        i.Factory.addGetterSetter(S, "flipEnabled", !0, (0,
        u.getBooleanValidator)()),
        i.Factory.addGetterSetter(S, "resizeEnabled", !0),
        i.Factory.addGetterSetter(S, "anchorSize", 10, (0,
        ...
        i.Factory.addGetterSetter(S, "rotateAnchorOffset", 50, (0,
        u.getNumberValidator)()),
        i.Factory.addGetterSetter(S, "rotateAnchorCursor", "crosshair"),
        i.Factory.addGetterSetter(S, "rotationSnapTolerance", 5, (0,
        u.getNumberValidator)()),
        i.Factory.addGetterSetter(S, "borderEnabled", !0),
        i.Factory.addGetterSetter(S, "anchorStroke", "rgb(0, 161, 255)"),
        i.Factory.addGetterSetter(S, "anchorStrokeWidth", 1, (0,
        u.getNumberValidator)()),
        i.Factory.addGetterSetter(S, "anchorFill", "white"),
        i.Factory.addGetterSetter(S, "anchorCornerRadius", 0, (0,
        u.getNumberValidator)()),
        i.Factory.addGetterSetter(S, "borderStroke", "rgb(0, 161, 255)"),
        i.Factory.addGetterSetter(S, "borderStrokeWidth", 1, (0,
        u.getNumberValidator)()),
        ...
        i.Factory.addGetterSetter(S, "padding", 0, (0,
        u.getNumberValidator)()),
    ...
    1020: function(t, e, r) {
        ...
        class l extends i.Shape {
            _sceneFunc(t) {
                t.beginPath(),
                t.arc(0, 0, this.radius(), 0, a.Konva.getAngle(this.angle()), this.clockwise()),
                t.lineTo(0, 0),
                t.closePath(),
                t.fillStrokeShape(this)
            }
        ...
        (0,
        s._registerNode)(l),
        n.Factory.addGetterSetter(l, "radius", 0, (0,
        o.getNumberValidator)()),
        n.Factory.addGetterSetter(l, "angle", 0, (0,
        o.getNumberValidator)()),
...
`
          , b = {};
        function _(t, e, r=b) {
            if (!g && "zIndex"in e && (console.warn(y),
            g = !0),
            !p && e.draggable) {
            ...
            for (var a in r)
                if (!f[a]) {
                    ...
                    if (o && s) {
                        ...
                        "content" === l.substr(0, 7) && (l = "content" + l.substr(7, 1).toUpperCase() + l.substr(8)),
                        t.off(l, r[a])
                    }
            ...
            for (var a in e)
                if (!f[a]) {
                    ...
                    !o && (e[a] !== r[a] || h && e[a] !== t.getAttr(a)) && (d = !0,
                    u[a] = e[a])
                }
            for (var l in d && (t.setAttrs(u),
            S(t)),
            c)
                t.on(l + v, c[l])
        }
        ...
        function P(t, e, r) {
            let n = l()[t];
            n || (console.error(`Konva has no node with the type ${t}. Group will be used instead. If you use minimal version of react-konva, just import required nodes into Konva: "import "konva/lib/shapes/${t}"  If you want to render DOM elements as part of canvas tree take a look into this demo: https://konvajs.github.io/docs/react/DOM_Portal.html`),
            n = l().Group);
            let i = {}
              , a = {};
            for (var o in e)
                "on" === o.slice(0, 2) ? a[o] = e[o] : i[o] = e[o];
            let s = new n(i);
            return _(s, a),
            s
        }
        ...
        function $(t, e, r) {
            console.error(`Text components are not yet supported in ReactKonva. You text is: "${r}"`)
        }
        function J(t, e, r) {}
        ...
        var ts = Object.defineProperty
          ...
          , tg = (t,e)=>{
            for (var r in e || (e = {}))
                td.call(e, r) && tf(t, r, e[r]);
            if (tu)
                for (var r of tu(e))
                    tc.call(e, r) && tf(t, r, e[r]);
            return t
        }
          , tp = (t,e)=>tl(t, th(e));
        function tv(t) {
        ...
        console.error = function() {
            ...
            if ((null == t ? void 0 : t.startsWith("Warning:")) && t.includes("useContext")) {
                console.error = tm;
                return
            }
        ...
        class tb extends o.Component {
            render() {
                return o.createElement(ty.Provider, {
        ...
        let t_ = t=>{
            let e = o.useRef()
              ...
              , a = function() {
                let t = function() {
                    ...
                    for (; r; ) {
                        if (r.type && "object" == typeof r.type) {
                            let t = void 0 === r.type._context && r.type.Provider === r.type ? r.type : r.type._context;
                ...
                return o.useMemo(()=>Array.from(t.keys()).reduce((e,r)=>n=>o.createElement(e, null, o.createElement(r.Provider, tp(tg({}, n), {
                    value: t.get(r)
                }))), t=>o.createElement(tb, tg({}, t))), [t])
            }()
              , s = e=>{
            ...
            ;
            return o.useLayoutEffect(()=>(r.current = new (l()).Stage({
                width: t.width,
                height: t.height,
                container: e.current
            }),
            s(r.current),
            n.current = tw.createContainer(r.current, d.LegacyRoot, !1, null),
            tw.updateContainer(o.createElement(a, {}, t.children), n.current),
            ()=>{
                l().isBrowser && (s(null),
                tw.updateContainer(null, n.current, null),
                r.current.destroy())
            }
            ), []),
            o.useLayoutEffect(()=>{
                s(r.current),
                _(r.current, t, i),
                tw.updateContainer(o.createElement(a, {}, t.children), n.current, null)
            }
            ),
            o.createElement("div", {
                ref: e,
          ...
          , tx = "Image"
          , tw = u()(a);
        tw.injectIntoDevTools({
            findHostInstanceByFiber: ()=>null,
            bundleType: 0,
            version: o.version,
            rendererPackageName: "react-konva"
        });
        let tC = o.forwardRef((t,e)=>o.createElement(tb, {}, o.createElement(t_, {
            ...t,
            forwardedRef: e
        })))
    },
 ...
 */
        t.exports = function(t) {
            "use strict";
            var e, n, i, a, o, s = {}, l = r(2265), h = r(7494), u = Object.assign;
            function d(t) {
            ...
            function F(t) {
                ...
                if ("object" == typeof t)
                    ...
                    case _:
                        ...
                        t;
                    case w:
                        return null !== (e = t.displayName || null) ? e : F(t.type) || "Memo";
                    case C:
                        e = t._payload,
                        t = t._init;
                        try {
            ...
            function A(t) {
                return null !== (t = M(t)) ? function t(e) {
                    if (5 === e.tag || 6 === e.tag)
                        return e;
            ...
            var R, D = Array.isArray, L = t.getPublicInstance, I = t.getRootHostContext, G = t.getChildHostContext, O = t.prepareForCommit, z = t.resetAfterCommit, U = t.createInstance, B = t.appendInitialChild, H = t.finalizeInitialChildren, V = t.prepareUpdate, j = t.shouldSetTextContent, W = t.createTextInstance, K = t.scheduleTimeout, Y = t.cancelTimeout, q = t.noTimeout, X = t.isPrimaryRenderer, Q = t.supportsMutation, $ = t.supportsPersistence, J = t.supportsHydration, Z = t.getInstanceFromNode, tt = t.preparePortalMount, te = t.getCurrentEventPriority, tr = t.detachDeletedInstance, tn = t.supportsMicrotasks, ti = t.scheduleMicrotask, ta = t.supportsTestSelectors, to = t.findFiberRoot, ts = t.getBoundingRect, tl = t.getTextContent, th = t.isHiddenSubtree, tu = t.matchAccessibilityRole, td = t.setFocusIfFocusable, tc = t.setupIntersectionObserver, tf = t.appendChild, tg = t.appendChildToContainer, tp = t.commitTextUpdate, tv = t.commitMount, tm = t.commitUpdate, ty = t.insertBefore, tb = t.insertInContainerBefore, t_ = t.removeChild, tS = t.removeChildFromContainer, tx = t.resetTextContent, tw = t.hideInstance, tC = t.hideTextInstance, tk = t.unhideInstance, tP = t.unhideTextInstance, tT = t.clearContainer, tF = t.cloneInstance, tE = t.createContainerChildSet, tN = t.appendChildToContainerChildSet, tM = t.finalizeContainerChildren, tA = t.replaceContainerChildren, tR = t.cloneHiddenInstance, tD = t.cloneHiddenTextInstance, tL = t.canHydrateInstance, tI = t.canHydrateTextInstance, tG = t.canHydrateSuspenseInstance, tO = t.isSuspenseInstancePending, tz = t.isSuspenseInstanceFallback, tU = t.getSuspenseInstanceFallbackErrorDetails, tB = t.registerSuspenseInstanceRetry, tH = t.getNextHydratableSibling, tV = t.getFirstHydratableChild, tj = t.getFirstHydratableChildWithinContainer, tW = t.getFirstHydratableChildWithinSuspenseInstance, tK = t.hydrateInstance, tY = t.hydrateTextInstance, tq = t.hydrateSuspenseInstance, tX = t.getNextHydratableInstanceAfterSuspenseInstance, tQ = t.commitHydratedContainer, t$ = t.commitHydratedSuspenseInstance, tJ = t.clearSuspenseBoundary, tZ = t.clearSuspenseBoundaryFromContainer, t0 = t.shouldDeleteUnhydratedTailInstances, t1 = t.didNotMatchHydratedContainerTextInstance, t2 = t.didNotMatchHydratedTextInstance;
            function t4(t) {
                if (void 0 === R)
                    try {
                        throw Error()
            ...
            function ed(t) {
                return t = (t = t.stateNode) && t.__reactInternalMemoizedMergedChildContext || er,
                ea = en.current,
                ee(en, t),
                ee(ei, ei.current),
                !0
            ...
            var ef = Math.clz32 ? Math.clz32 : function(t) {
            ...
            function eb(t, e) {
                ...
                if (0 !== o) {
                    ...
                    0 != (o = r & ~i) ? n = ey(o) : 0 !== a && (n = ey(a));
                if (0 === n)
                    return 0;
                if (0 !== e && e !== n && 0 == (e & i) && ((i = n & -n) >= (a = e & -e) || 16 === i && 0 != (4194240 & a)))
                    return e;
                if (0 != (4 & n) && (n |= 16 & r),
            ...
            var eT = h.unstable_scheduleCallback
              , eF = h.unstable_cancelCallback
              , eE = h.unstable_shouldYield
              , eN = h.unstable_requestPaint
              , eM = h.unstable_now
              ...
              , eI = null
              , eG = null
              , eO = "function" == typeof Object.is ? Object.is : function(t, e) {
            ...
            var e4 = null
              ...
              , e8 = null;
            function e7(t, e) {
                var r = aQ(5, null, null, 0);
                r.elementType = "DELETED",
                r.stateNode = e,
                r.return = t,
                null === (e = t.deletions) ? (t.deletions = [r],
                t.flags |= 16) : e.push(r)
            }
            function e9(t, e) {
                switch (t.tag) {
                case 5:
                    return null !== (e = tL(e, t.type, t.pendingProps)) && (t.stateNode = e,
                    e4 = t,
                    e3 = tV(e),
                    !0);
                case 6:
                    return null !== (e = tI(e, t.pendingProps)) && (t.stateNode = e,
                    e4 = t,
                    e3 = null,
                    !0);
                case 13:
                    if (null !== (e = tG(e))) {
                        ...
                        (r = aQ(18, null, null, 0)).stateNode = e,
                        r.return = t,
                        t.child = r,
                        e4 = t,
                        e3 = null,
                ...
                if (e5) {
                    ...
                    if (e) {
                        ...
                        if (!e9(t, e)) {
                            ...
                            e = tH(r);
                            var n = e4;
                            e && e9(t, e) ? e7(n, r) : (t.flags = -4097 & t.flags | 2,
                            e5 = !1,
                            e4 = t)
                        }
                    } else {
            ...
            function rn(t) {
                ...
                if (!e5)
                    ...
                    e5 = !0,
                    !1;
                if (3 !== t.tag && (5 !== t.tag || t0(t.type) && !j(t.type, t.memoizedProps))) {
                    var e = e3;
                    if (e) {
                        if (rt(t))
                            throw ri(),
            ...
            function rp(t, e, r) {
                X ? (ee(ru, e._currentValue),
                e._currentValue = r) : (ee(ru, e._currentValue2),
                e._currentValue2 = r)
            }
            function rv(t) {
                var e = ru.current;
                et(ru),
                X ? t._currentValue = e : t._currentValue2 = e
            }
            function rm(t, e, r) {
                for (; null !== t; ) {
                    var n = t.alternate;
                    if ((t.childLanes & e) !== e ? (t.childLanes |= e,
                    null !== n && (n.childLanes |= e)) : null !== n && (n.childLanes & e) !== e && (n.childLanes |= e),
                    t === r)
                        break;
                    t = t.return
                }
            ...
            function ry(t, e) {
                rd = t,
                rf = rc = null,
                null !== (t = t.dependencies) && null !== t.firstContext && (0 != (t.lanes & e) && (n4 = !0),
                t.firstContext = null)
            }
            function rb(t) {
            ...
            function rF(t, e, r) {
                ...
                return null === (i = n.interleaved) ? (e.next = e,
                rS(n)) : (e.next = i.next,
                i.next = e),
                n.interleaved = e,
                rw(t, r)
            ...
            function rN(t, e) {
                ...
                null === (t = r.lastBaseUpdate) ? r.firstBaseUpdate = e : t.next = e,
                r.lastBaseUpdate = e
            }
            function rM(t, e, r, n) {
                var i = t.updateQueue;
                ...
                if (null !== s) {
                    ...
                    o = l;
                    var d = t.alternate;
                    null !== d && (s = (d = d.updateQueue).lastBaseUpdate) !== o && (null === s ? d.firstBaseUpdate = h : s.next = h,
                    d.lastBaseUpdate = l)
                }
                if (null !== a) {
                    var c = i.baseState;
                    ...
                    s = a; ; ) {
                        ...
                        if ((n & f) === f) {
                            ...
                            t: {
                                ...
                                case 0:
                                    if (null == (f = "function" == typeof (p = v.payload) ? p.call(g, c, f) : p))
                                        break t;
                                    c = u({}, c, f);
                                    break t;
                                case 2:
                            ...
                            null !== s.callback && 0 !== s.lane && (t.flags |= 64,
            ...
            var rL = {
                isMounted: function(t) {
                    return !!(t = t._reactInternals) && E(t) === t
                },
                ...
                enqueueForceUpdate: function(t, e) {
                    ...
                    i.tag = 2,
                    null != e && (i.callback = e),
                    null !== (e = rF(t, i, n)) && (ak(e, t, n, r),
                    rE(e, t, n))
                }
            };
            function rI(t, e, r, n, i, a, o) {
                return "function" == typeof (t = t.stateNode).shouldComponentUpdate ? t.shouldComponentUpdate(n, a, o) : !e.prototype || !e.prototype.isPureReactComponent || !rl(r, n) || !rl(i, a)
            }
            function rG(t, e, r) {
                var n = !1
                  , i = er
                  , a = e.contextType;
                return "object" == typeof a && null !== a ? a = rb(a) : (i = es(e) ? ea : en.current,
                ...
                t.stateNode = e,
                e._reactInternals = t,
                n && ((t = t.stateNode).__reactInternalMemoizedUnmaskedChildContext = i,
                t.__reactInternalMemoizedMaskedChildContext = a),
                e
            }
            function rO(t, e, r, n) {
            ...
            function rz(t, e, r, n) {
                ...
                rk(t);
                var a = e.contextType;
                "object" == typeof a && null !== a ? i.context = rb(a) : (a = es(e) ? ea : en.current,
                i.context = eo(t, a)),
                i.state = t.memoizedState,
                "function" == typeof (a = e.getDerivedStateFromProps) && (rD(t, e, a, r),
                i.state = t.memoizedState),
            ...
            function rB(t, e) {
                throw Error(d(31, "[object Object]" === (t = Object.prototype.toString.call(e)) ? "object with keys {" + Object.keys(e).join(", ") + "}" : t))
            }
            function rH(t) {
                return (0,
                t._init)(t._payload)
            ...
            function rV(t) {
                ...
                function i(t, e) {
                    return (t = aJ(t, e)).index = 0,
                    t.sibling = null,
                    t
                }
                function a(e, r, n) {
                    return (e.index = n,
                    t) ? null !== (n = e.alternate) ? (n = n.index) < r ? (e.flags |= 2,
                    r) : n : (e.flags |= 2,
                    r) : (e.flags |= 1048576,
                    r)
                }
                ...
                function s(t, e, r, n) {
                    return null === e || 6 !== e.tag ? (e = a2(r, t.mode, n)).return = t : (e = i(e, r)).return = t,
                    e
                }
                function l(t, e, r, n) {
                    var a = r.type;
                    return a === p ? u(t, e, r.props.children, n, r.key) : (null !== e && (e.elementType === a || "object" == typeof a && null !== a && a.$$typeof === C && rH(a) === e.type) ? (n = i(e, r.props)).ref = rU(t, e, r) : (n = aZ(r.type, r.key, r.props, null, t.mode, n)).ref = rU(t, e, r),
                    n.return = t,
                    n)
                }
                function h(t, e, r, n) {
                    return null === e || 4 !== e.tag || e.stateNode.containerInfo !== r.containerInfo || e.stateNode.implementation !== r.implementation ? (e = a4(r, t.mode, n)).return = t : (e = i(e, r.children || [])).return = t,
                    e
                }
                function u(t, e, r, n, a) {
                    return null === e || 7 !== e.tag ? (e = a0(r, t.mode, n, a)).return = t : (e = i(e, r)).return = t,
                    e
                }
                function c(t, e, r) {
                    if ("string" == typeof e && "" !== e || "number" == typeof e)
                        return (e = a2("" + e, t.mode, r)).return = t,
                        e;
                    if ("object" == typeof e && null !== e) {
                        switch (e.$$typeof) {
                        case f:
                            return (r = aZ(e.type, e.key, e.props, null, t.mode, r)).ref = rU(t, null, e),
                            r.return = t,
                            r;
                        case g:
                            return (e = a4(e, t.mode, r)).return = t,
                            e;
                        case C:
                            return c(t, (0,
                            e._init)(e._payload), r)
                        }
                        if (D(e) || T(e))
                            return (e = a0(e, t.mode, r, null)).return = t,
                            e;
                        rB(t, e)
                    }
                    return null
                ...
                function v(t, e, r, n) {
                    ...
                    if ("object" == typeof r && null !== r) {
                        ...
                        if (D(r) || T(r))
                            return null !== i ? null : u(t, e, r, n, null);
                        rB(t, r)
                    }
                    return null
                }
                function m(t, e, r, n, i) {
                    ...
                    if ("object" == typeof n && null !== n) {
                        switch (n.$$typeof) {
                        case f:
                            return l(e, t = t.get(null === n.key ? r : n.key) || null, n, i);
                        case g:
                            return h(e, t = t.get(null === n.key ? r : n.key) || null, n, i);
                        case C:
                            return m(t, e, r, (0,
                            n._init)(n._payload), i)
                        }
                        if (D(n) || T(n))
                            return u(e, t = t.get(r) || null, n, i, null);
                        rB(e, n)
                    }
                    return null
                }
                return function s(l, h, u, y) {
                    if ("object" == typeof u && null !== u && u.type === p && null === u.key && (u = u.props.children),
                    "object" == typeof u && null !== u) {
                            ...
                            t: {
                                for (var b = u.key, _ = h; null !== _; ) {
                                    if (_.key === b) {
                                        ...
                                        } else if (_.elementType === b || "object" == typeof b && null !== b && b.$$typeof === C && rH(b) === _.type) {
                                            r(l, _.sibling),
                                            (h = i(_, u.props)).ref = rU(l, _, u),
                                            h.return = l,
                                            l = h;
                                            break t
                                        }
                                ...
                                u.type === p ? ((h = a0(u.props.children, l.mode, y, u.key)).return = l,
                                l = h) : ((y = aZ(u.type, u.key, u.props, null, l.mode, y)).ref = rU(l, h, u),
                                y.return = l,
                                l = y)
                            }
                            return o(l);
                        case g:
                            t: {
                                for (_ = u.key; null !== h; ) {
                                    if (h.key === _) {
                                        if (4 === h.tag && h.stateNode.containerInfo === u.containerInfo && h.stateNode.implementation === u.implementation) {
                                            r(l, h.sibling),
                        ...
                        if (D(u))
                            return function(i, o, s, l) {
                                for (var h = null, u = null, d = o, f = o = 0, g = null; null !== d && f < s.length; f++) {
                                    d.index > f ? (g = d,
                                    d = null) : g = d.sibling;
                                    var p = v(i, d, s[f], l);
                                    if (null === p) {
                                ...
                                for (d = n(i, d); f < s.length; f++)
                                    null !== (g = m(d, i, f, s[f], l)) && (t && null !== g.alternate && d.delete(null === g.key ? f : g.key),
                                    o = a(g, o, f),
                        ...
                        if (T(u))
                            return function(i, o, s, l) {
                                ...
                                if (null == (s = h.call(s)))
                                    throw Error(d(151));
                                for (var u = h = null, f = o, g = o = 0, p = null, y = s.next(); null !== f && !y.done; g++,
                                y = s.next()) {
                                    f.index > g ? (p = f,
                                    f = null) : p = f.sibling;
                                ...
                                if (null === f) {
                                    for (; !y.done; g++,
                                    y = s.next())
                                        null !== (y = c(i, y.value, l)) && (o = a(y, o, g),
                                        null === u ? h = y : u.sibling = y,
                                        u = y);
                                    return e5 && eZ(i, g),
                                    h
                                }
                                for (f = n(i, f); !y.done; g++,
                                y = s.next())
                                    null !== (y = m(f, i, g, y.value, l)) && (t && null !== y.alternate && f.delete(null === y.key ? g : y.key),
                                    o = a(y, o, g),
                                    null === u ? h = y : u.sibling = y,
                                    u = y);
                    ...
                    null !== h && 6 === h.tag ? (r(l, h.sibling),
                    (h = i(h, u)).return = l) : (r(l, h),
                    (h = a2(u, l.mode, y)).return = l),
                    o(l = h)) : r(l, h)
                }
            }
            var rj = rV(!0)
            ...
            var r4 = [];
            function r3() {
                for (var t = 0; t < r4.length; t++) {
                    var e = r4[t];
                    X ? e._workInProgressVersionPrimary = null : e._workInProgressVersionSecondary = null
                }
                r4.length = 0
            }
            var r5 = c.ReactCurrentDispatcher
              , r6 = c.ReactCurrentBatchConfig
              , r8 = 0
              , r7 = null
              , r9 = null
              , nt = null
            ...
            function ns(t, e, r, n, i, a) {
                ...
                e.updateQueue = null,
                e.lanes = 0,
                r5.current = null === t || null === t.memoizedState ? nj : nW,
                t = r(n, i),
                nr) {
                    a = 0;
                    do {
            ...
            function nh() {
                ...
                return null === nt ? r7.memoizedState = nt = t : nt = nt.next = t,
                nt
            }
            function nu() {
                if (null === r9) {
                    ...
                    t = r9.next;
                var e = null === nt ? r7.memoizedState : nt.next;
                if (null !== e)
                    nt = e,
                    r9 = t;
                else {
                    if (null === t)
                        throw Error(d(310));
                    t = {
                        memoizedState: (r9 = t).memoizedState,
                        baseState: r9.baseState,
                        baseQueue: r9.baseQueue,
                        queue: r9.queue,
                        next: null
                    },
                    null === nt ? r7.memoizedState = nt = t : nt = nt.next = t
                }
                return nt
            }
            function nd(t, e) {
            ...
            function np(t, e) {
                ...
                if (a && (n.memoizedState = i,
                n4 = !0),
                n = n.queue,
                nT(ny.bind(null, r, n, t), [t]),
                n.getSnapshot !== e || a || null !== nt && 1 & nt.memoizedState.tag) {
                    if (r.flags |= 2048,
                    nx(9, nm.bind(null, r, n, i, e), void 0, null),
                    null === i8)
                        throw Error(d(349));
                    0 != (30 & r8) || nv(r, e, i)
                }
            ...
            function nv(t, e, r) {
                ...
                null === (e = r7.updateQueue) ? (e = {
                    lastEffect: null,
                    stores: null
                },
                r7.updateQueue = e,
                e.stores = [t]) : null === (r = e.stores) ? e.stores = [t] : r.push(t)
            }
            function nm(t, e, r, n) {
                e.value = r,
                e.getSnapshot = n,
            ...
            function nS(t) {
                ...
                e.queue = t,
                t = t.dispatch = nz.bind(null, r7, t),
                [e.memoizedState, t]
            }
            function nx(t, e, r, n) {
                return t = {
                ...
                r7.updateQueue = e,
                e.lastEffect = t.next = t) : null === (r = e.lastEffect) ? e.lastEffect = t.next = t : (n = r.next,
                r.next = t,
                t.next = n,
                e.lastEffect = t),
                t
            ...
            function nC(t, e, r, n) {
                var i = nh();
                r7.flags |= t,
                i.memoizedState = nx(1 | e, r, void 0, void 0 === n ? null : n)
            }
            function nk(t, e, r, n) {
                var i = nu();
                n = void 0 === n ? null : n;
                ...
                if (null !== r9) {
                    ...
                    if (a = o.destroy,
                    null !== n && no(n, o.deps)) {
                        i.memoizedState = nx(e, r, a, n);
                        return
                    }
                }
                r7.flags |= t,
                i.memoizedState = nx(1 | e, r, a, n)
            }
            function nP(t, e) {
                return nC(8390656, 8, t, e)
            }
            function nT(t, e) {
                return nk(2048, 8, t, e)
            }
            function nF(t, e) {
                return nk(4, 2, t, e)
            }
            ...
            function nR(t, e) {
                ...
                return null !== n && null !== e && no(e, n[1]) ? n[0] : (r.memoizedState = [t, e],
                t)
            }
            function nD(t, e) {
                var r = nu();
                e = void 0 === e ? null : e;
                var n = r.memoizedState;
                return null !== n && null !== e && no(e, n[1]) ? n[0] : (t = t(),
                r.memoizedState = [t, e],
                t)
            }
            function nL(t, e, r) {
                return 0 == (21 & r8) ? (t.baseState && (t.baseState = !1,
                n4 = !0),
                t.memoizedState = r) : (eO(r, e) || (r = eS(),
                r7.lanes |= r,
                ai |= r,
                t.baseState = !0),
                e)
            ...
            function nO(t, e, r) {
                ...
                nU(t) ? nB(e, r) : null !== (r = rx(t, e, r, n)) && (ak(r, t, n, aw()),
                nH(r, e, n))
            }
            function nz(t, e, r) {
                var n = aC(t)
                ...
                if (nU(t))
                    ...
                    null !== (r = rx(t, e, i, n)) && (ak(r, t, n, i = aw()),
                    nH(r, e, n))
                }
            }
            function nU(t) {
                var e = t.alternate;
                return t === r7 || null !== e && e === r7
            }
            function nB(t, e) {
                nr = ne = !0;
                var r = t.pending;
                null === r ? e.next = e : (e.next = r.next,
                r.next = e),
                t.pending = e
            }
            function nH(t, e, r) {
            ...
            var nV = {
              ...
              , nj = {
                ...
                useCallback: function(t, e) {
                    return nh().memoizedState = [t, void 0 === e ? null : e],
                    t
                },
                useContext: rb,
                useEffect: nP,
                useImperativeHandle: function(t, e, r) {
                    return r = null != r ? r.concat([t]) : null,
                    nC(4194308, 4, nN.bind(null, e, t), r)
                },
                ...
                useReducer: function(t, e, r) {
                    ...
                    n.queue = t,
                    t = t.dispatch = nO.bind(null, r7, t),
                    [n.memoizedState, t]
                },
                useRef: function(t) {
                    return t = {
                ...
                useDeferredValue: function(t) {
                    return nh().memoizedState = t
                },
                useTransition: function() {
                    var t = nS(!1)
                      , e = t[0];
                    return t = nI.bind(null, t[1]),
                    nh().memoizedState = t,
                    [e, t]
                },
                ...
                useSyncExternalStore: function(t, e, r) {
                    ...
                    return i.queue = a,
                    nP(ny.bind(null, n, a, t), [t]),
                    n.flags |= 2048,
                    nx(9, nm.bind(null, n, a, r, e), void 0, null),
                    r
                },
                useId: function() {
                    var t = nh()
                      , e = i8.identifierPrefix;
                    if (e5) {
                        var r = eJ
                          , n = e$;
                        e = ":" + e + "R" + (r = (n & ~(1 << 32 - ef(n) - 1)).toString(32) + r),
                        0 < (r = nn++) && (e += "H" + r.toString(32)),
                        e += ":"
                    } else
                        e = ":" + e + "r" + (r = ni++).toString(32) + ":";
              ...
              , nW = {
                ...
                useDebugValue: nA,
                useDeferredValue: function(t) {
                    return nL(nu(), r9.memoizedState, t)
                },
                useTransition: function() {
                    return [nc(nd)[0], nu().memoizedState]
                },
                useMutableSource: ng,
              ...
              , nK = {
                ...
                useDeferredValue: function(t) {
                    var e = nu();
                    return null === r9 ? e.memoizedState = t : nL(e, r9.memoizedState, t)
                },
                useTransition: function() {
                    return [nf(nd)[0], nu().memoizedState]
                },
                useMutableSource: ng,
                useSyncExternalStore: np,
                useId: nG,
                ...
                try {
                    ...
                    do
                        r += function(t) {
                            ...
                            case 2:
                            case 15:
                                return t = t5(t.type, !1);
                            case 11:
                                return t = t5(t.type.render, !1);
                            case 1:
                                return t = t5(t.type, !0);
                            default:
                                return ""
                            }
                        }(n),
            ...
            var nQ = "function" == typeof WeakMap ? WeakMap : Map;
            function n$(t, e, r) {
                (r = rT(-1, r)).tag = 3,
                r.payload = {
                    element: null
            ...
            function nJ(t, e, r) {
                ...
                return null !== a && "function" == typeof a.componentDidCatch && (r.callback = function() {
                    nX(t, e),
                    "function" != typeof n && (null === ap ? ap = new Set([this]) : ap.add(this));
                    var r = e.stack;
            ...
            function nZ(t, e, r) {
                var n = t.pingCache;
                if (null === n) {
                    n = t.pingCache = new nQ;
                    var i = new Set;
                    n.set(e, i)
                } else
                    void 0 === (i = n.get(e)) && (i = new Set,
                    n.set(e, i));
                i.has(r) || (i.add(r),
                t = aW.bind(null, t, e, r),
                e.then(t, t))
            }
            function n0(t) {
                do {
            ...
            function n1(t, e, r, n, i) {
                return 0 == (1 & t.mode) ? t === e ? t.flags |= 65536 : (t.flags |= 128,
                r.flags |= 131072,
                r.flags &= -52805,
                1 === r.tag && (null === r.alternate ? r.tag = 17 : ((e = rT(-1, 1)).tag = 2,
                rF(r, e, 1))),
                r.lanes |= 1) : (t.flags |= 65536,
                t.lanes = i),
                t
            }
            var n2 = c.ReactCurrentOwner
              , n4 = !1;
            function n3(t, e, r, n) {
                e.child = null === t ? rW(e, null, r, n) : rj(e, t.child, r, n)
            }
            ...
            function n6(t, e, r, n, i) {
                if (null === t) {
                    var a = r.type;
                    return "function" != typeof a || a$(a) || void 0 !== a.defaultProps || null !== r.compare || void 0 !== r.defaultProps ? ((t = aZ(r.type, null, n, e, e.mode, i)).ref = e.ref,
                    t.return = e,
                    e.child = t) : (e.tag = 15,
                    e.type = a,
                    n8(t, e, a, n, i))
                ...
                0 == (t.lanes & i)) {
                    ...
                    if ((r = null !== (r = r.compare) ? r : rl)(o, n) && t.ref === e.ref)
                        return iv(t, e, i)
                }
                return e.flags |= 1,
                (t = aJ(a, n)).ref = e.ref,
            ...
            function n7(t, e, r) {
                ...
                if ("hidden" === n.mode) {
                    if (0 == (1 & e.mode))
                        ...
                        if (0 == (1073741824 & r))
                            return t = null !== a ? a.baseLanes | r : r,
            ...
            function n9(t, e) {
                var r = e.ref;
                (null === t && null !== r || null !== t && t.ref !== r) && (e.flags |= 512,
                e.flags |= 2097152)
            }
            ...
            function ie(t, e, r, n, i) {
                ...
                null === e.stateNode)
                    ...
                    var l = o.context
                      , h = r.contextType;
                    h = "object" == typeof h && null !== h ? rb(h) : eo(e, h = es(r) ? ea : en.current);
                    var u = r.getDerivedStateFromProps
                      , d = "function" == typeof u || "function" == typeof o.getSnapshotBeforeUpdate;
                    d || "function" != typeof o.UNSAFE_componentWillReceiveProps && "function" != typeof o.componentWillReceiveProps || (s !== n || l !== h) && rO(e, o, n, h),
                    rC = !1;
                    var c = e.memoizedState;
                    o.state = c,
                    rM(e, n, o, i),
                    l = e.memoizedState,
                    s !== n || c !== l || ei.current || rC ? ("function" == typeof u && (rD(e, r, u, n),
                    l = e.memoizedState),
                    (s = rC || rI(e, r, s, n, c, l, h)) ? (d || "function" != typeof o.UNSAFE_componentWillMount && "function" != typeof o.componentWillMount || ("function" == typeof o.componentWillMount && o.componentWillMount(),
                    ...
                    o.state = l,
                    o.context = h,
                    n = s) : ("function" == typeof o.componentDidMount && (e.flags |= 4194308),
                    n = !1)
                } else {
                    o = e.stateNode,
                    rP(t, e),
                    s = e.memoizedProps,
                    h = e.type === e.elementType ? s : rh(e.type, s),
                    o.props = h,
                    d = e.pendingProps,
                    c = o.context,
                    l = "object" == typeof (l = r.contextType) && null !== l ? rb(l) : eo(e, l = es(r) ? ea : en.current);
                    var f = r.getDerivedStateFromProps;
                    (u = "function" == typeof f || "function" == typeof o.getSnapshotBeforeUpdate) || "function" != typeof o.UNSAFE_componentWillReceiveProps && "function" != typeof o.componentWillReceiveProps || (s !== d || c !== l) && rO(e, o, n, l),
                    rC = !1,
                    c = e.memoizedState,
                    o.state = c,
                    rM(e, n, o, i);
                    var g = e.memoizedState;
                    s !== d || c !== g || ei.current || rC ? ("function" == typeof f && (rD(e, r, f, n),
                    g = e.memoizedState),
                    (h = rC || rI(e, r, h, n, c, g, l) || !1) ? (u || "function" != typeof o.UNSAFE_componentWillUpdate && "function" != typeof o.componentWillUpdate || ("function" == typeof o.componentWillUpdate && o.componentWillUpdate(n, g, l),
                    "function" == typeof o.UNSAFE_componentWillUpdate && o.UNSAFE_componentWillUpdate(n, g, l)),
                    "function" == typeof o.componentDidUpdate && (e.flags |= 4),
                    "function" == typeof o.getSnapshotBeforeUpdate && (e.flags |= 1024)) : ("function" != typeof o.componentDidUpdate || s === t.memoizedProps && c === t.memoizedState || (e.flags |= 4),
                    "function" != typeof o.getSnapshotBeforeUpdate || s === t.memoizedProps && c === t.memoizedState || (e.flags |= 1024),
                    e.memoizedProps = n,
                    e.memoizedState = g),
                    o.props = n,
                    o.state = g,
                    o.context = l,
                    n = h) : ("function" != typeof o.componentDidUpdate || s === t.memoizedProps && c === t.memoizedState || (e.flags |= 4),
                    "function" != typeof o.getSnapshotBeforeUpdate || s === t.memoizedProps && c === t.memoizedState || (e.flags |= 1024),
                    n = !1)
                }
                return ir(t, e, r, n, a, i)
            }
            function ir(t, e, r, n, i, a) {
                n9(t, e);
                var o = 0 != (128 & e.flags);
                if (!n && !o)
                    return i && ec(e, r, !1),
                ...
                return e.flags |= 1,
                null !== t && o ? (e.child = rj(e, t.child, null, a),
                e.child = rj(e, null, s, a)) : n3(t, e, s, a),
            ...
            function ii(t) {
                var e = t.stateNode;
                e.pendingContext ? eh(t, e.pendingContext, e.pendingContext !== e.context) : e.context && eh(t, e.context, !1),
                r$(t, e.containerInfo)
            }
            ...
            function il(t, e, r) {
                var n, i = e.pendingProps, a = r1.current, o = !1, s = 0 != (128 & e.flags);
                if ((n = s) || (n = (null === t || null !== t.memoizedState) && 0 != (2 & a)),
                n ? (o = !0,
                e.flags &= -129) : (null === t || null !== t.memoizedState) && (a |= 1),
                ee(r1, 1 & a),
                null === t)
                    return (re(e),
                    null !== (t = e.memoizedState) && null !== (t = t.dehydrated)) ? (0 == (1 & e.mode) ? e.lanes = 1 : tz(t) ? e.lanes = 8 : e.lanes = 1073741824,
                    null) : (s = i.children,
                    t = i.fallback,
                    o ? (i = e.mode,
                    o = e.child,
                    ...
                    o.pendingProps = s) : o = a1(s, i, 0, null),
                    t = a0(t, i, r, null),
                    o.return = e,
                    t.return = e,
                    o.sibling = t,
                    e.child = o,
                    e.child.memoizedState = is(r),
                    e.memoizedState = io,
                    t) : ih(e, s));
                if (null !== (a = t.memoizedState) && null !== (n = a.dehydrated))
                    return function(t, e, r, n, i, a, o) {
                        if (r)
                            ...
                            iu(t, e, o, n = nq(Error(d(422))))) : null !== e.memoizedState ? (e.child = t.child,
                            e.flags |= 128,
                            null) : (a = n.fallback,
                            i = e.mode,
                            n = a1({
                            ...
                            n.sibling = a,
                            e.child = n,
                            0 != (1 & e.mode) && rj(e, t.child, null, o),
                            e.child.memoizedState = is(o),
                            e.memoizedState = io,
                            a);
                        if (0 == (1 & e.mode))
                            return iu(t, e, o, null);
                        if (tz(i))
                            return n = tU(i).digest,
                            iu(t, e, o, n = nq(a = Error(d(419)), n, void 0));
                        if (r = 0 != (o & t.childLanes),
                        n4 || r) {
                            if (null !== (n = i8)) {
                                switch (o & -o) {
                                case 4:
                                ...
                                0 !== (i = 0 != (i & (n.suspendedLanes | o)) ? 0 : i) && i !== a.retryLane && (a.retryLane = i,
                                rw(t, i),
                                ak(n, t, i, -1))
                            }
                            return aG(),
                            iu(t, e, o, n = nq(Error(d(421))))
                        }
                        return tO(i) ? (e.flags |= 128,
                        e.child = t.child,
                        tB(i, e = aY.bind(null, t)),
                        null) : (t = a.treeContext,
                        J && (e3 = tW(i),
                        e4 = e,
                        e5 = !0,
                        e8 = null,
                ...
                if (o) {
                    ...
                    return 0 == (1 & s) && e.child !== a ? ((i = e.child).childLanes = 0,
                    i.pendingProps = l,
                    e.deletions = null) : (i = aJ(a, l)).subtreeFlags = 14680064 & a.subtreeFlags,
                    null !== n ? o = aJ(n, o) : (o = a0(o, s, r, null),
                    o.flags |= 2),
                    o.return = e,
                    i.return = e,
                    i.sibling = o,
                    ...
                    i = o,
                    o = e.child,
                    s = null === (s = t.child.memoizedState) ? is(r) : {
                ...
                i.return = e,
                i.sibling = null,
                null !== t && (null === (r = e.deletions) ? (e.deletions = [t],
                e.flags |= 16) : r.push(t)),
                e.child = i,
                e.memoizedState = null,
                i
            ...
            function iu(t, e, r, n) {
                return null !== n && ro(n),
                rj(e, t.child, null, r),
                t = ih(e, e.pendingProps.children),
                t.flags |= 2,
                e.memoizedState = null,
                t
            }
            ...
            function ig(t, e, r) {
                ...
                0 == (1 & e.mode))
                    ...
                    case "forwards":
                        for (i = null,
                        r = e.child; null !== r; )
                            null !== (t = r.alternate) && null === r2(t) && (i = r),
                            r = r.sibling;
                        null === (r = i) ? (i = e.child,
                        e.child = null) : (i = r.sibling,
                        r.sibling = null),
                        ic(e, !1, i, r, a);
                        break;
                    case "backwards":
                        ...
                        i = e.child,
                        e.child = null; null !== i; ) {
                            if (null !== (t = i.alternate) && null === r2(t)) {
                                e.child = i;
                                break
                            }
                            t = i.sibling,
            ...
            function iv(t, e, r) {
                ...
                if (null !== t && e.child !== t.child)
                    throw Error(d(153));
                if (null !== e.child) {
                    for (r = aJ(t = e.child, t.pendingProps),
                    e.child = r,
                    r.return = e; null !== t.sibling; )
                        t = t.sibling,
                        (r = r.sibling = aJ(t, t.pendingProps)).return = e;
                    r.sibling = null
                }
                return e.child
            }
            ...
            if (Q)
                ...
                i = function(t, e, r, n, i) {
                    (t = t.memoizedProps) !== n && (r = V(e.stateNode, r, t, n, i, rQ(rY.current)),
                    (e.updateQueue = r) && im(e))
                }
                ,
                a = function(t, e, r, n) {
                    r !== n && im(e)
                ...
                e = function(t, r, n, i) {
                    for (var a = r.child; null !== a; ) {
                        if (5 === a.tag) {
                            var o = a.stateNode;
                            n && i && (o = tR(o, a.type, a.memoizedProps, a)),
                            B(t, o)
                        } else if (6 === a.tag)
                            o = a.stateNode,
                ...
                ;
                var ib = function(t, e, r, n) {
                    for (var i = e.child; null !== i; ) {
                        if (5 === i.tag) {
                            var a = i.stateNode;
                            r && n && (a = tR(a, i.type, i.memoizedProps, i)),
                            tN(t, a)
                        } else if (6 === i.tag)
                            a = i.stateNode,
                ...
                i = function(t, r, n, i, a) {
                    ...
                    if ((t = iy(t, r)) && s === i)
                        ...
                        var l = r.stateNode
                          ...
                          , u = null;
                        s !== i && (u = V(l, n, s, i, a, h)),
                        t && null === u ? r.stateNode = o : (H(o = tF(o, u, n, s, i, r, t, l), n, i, a, h) && im(r),
                        r.stateNode = o,
                        t ? im(r) : e(o, r, !1, !1))
                    }
                }
            ...
            function iR(t) {
                t: for (; ; ) {
                    for (; null === t.sibling; ) {
                        if (null === t.return || iA(t.return))
                            return null;
                        t = t.return
                    }
                    for (t.sibling.return = t.return,
                    t = t.sibling; 5 !== t.tag && 6 !== t.tag && 18 !== t.tag; ) {
                        if (2 & t.flags || null === t.child || 4 === t.tag)
                            continue t;
                        t.child.return = t,
                        t = t.child
                    }
            ...
            function iG(t, e, r) {
                ...
                case 6:
                    if (Q) {
                        ...
                        iD = n,
                        iL = i,
                        null !== iD && (iL ? tS(iD, r.stateNode) : t_(iD, r.stateNode))
                    } else
                        iI(t, e, r);
                    break;
                case 18:
                    Q && null !== iD && (iL ? tZ(iD, r.stateNode) : tJ(iD, r.stateNode));
                    break;
                case 4:
                    Q ? (n = iD,
                    i = iL,
                    iD = r.stateNode.containerInfo,
                    iL = !0,
                    iI(t, e, r),
                    iD = n,
                    iL = i) : ($ && (i = tE(n = r.stateNode.containerInfo),
                    tA(n, i)),
                    iI(t, e, r));
                    break;
                case 0:
                ...
                case 14:
                case 15:
                    if (!iw && null !== (n = r.updateQueue) && null !== (n = n.lastEffect)) {
                        i = n = n.next;
                        do {
                            var a = i
                              , o = a.destroy;
                            a = a.tag,
                            void 0 !== o && (0 != (2 & a) ? iT(r, e, o) : 0 != (4 & a) && iT(r, e, o)),
                            i = i.next
                        } while (i !== n)
                    }
                    iI(t, e, r);
                ...
                default:
                    ...
                    break;
                case 22:
                    1 & r.mode ? (iw = (n = iw) || null !== r.memoizedState,
                    iI(t, e, r),
                    iw = n) : iI(t, e, r)
                }
            }
            function iO(t) {
                ...
                if (null !== e) {
                    t.updateQueue = null;
                    var r = t.stateNode;
                    null === r && (r = t.stateNode = new iC),
                    e.forEach(function(e) {
                        var n = aq.bind(null, t, e);
                        r.has(e) || (r.add(e),
                        e.then(n, n))
                    })
                }
            ...
            function iU(t, e) {
                ...
                case 13:
                    ...
                    a && (null === i.alternate || null === i.alternate.memoizedState) && (ah = eM())),
                    4 & n && iO(t);
                    break;
                case 22:
                    var o = null !== r && null !== r.memoizedState;
                    if (1 & t.mode ? (iw = (r = iw) || o,
                    iz(e, t),
                    iw = r) : iz(e, t),
                    iB(t),
                    8192 & n) {
                        if (r = null !== t.memoizedState,
                    ...
                    if (0 != (8772 & e.flags)) {
                        ...
                        try {
                            if (0 != (8772 & e.flags))
                                ...
                                case 1:
                                    ...
                                    if (4 & e.flags && !iw) {
                                        if (null === r)
                                            ...
                                            var i = e.elementType === e.type ? r.memoizedProps : rh(e.type, r.memoizedProps);
                                ...
                                case 5:
                                    var s = e.stateNode;
                                    null === r && 4 & e.flags && tv(s, e.type, e.memoizedProps, e);
                                    break;
                                case 6:
                                case 4:
                                case 12:
            ...
            if ("function" == typeof Symbol && Symbol.for) {
                ...
                iK = iQ("selector.has_pseudo_class"),
                iY = iQ("selector.role"),
                iq = iQ("selector.test_id"),
                iX = iQ("selector.text")
            }
            function i$(t) {
                var e = Z(t);
            ...
            function iJ(t, e) {
                ...
                case iK:
                    ...
                    return e;
                case iY:
                    if (5 === t.tag && tu(t.stateNode, e.value))
                        return !0;
                    break;
                case iX:
                    if ((5 === t.tag || 6 === t.tag) && null !== (t = tl(t)) && 0 <= t.indexOf(e.value))
                        return !0;
                    break;
                case iq:
                    if (5 === t.tag && "string" == typeof (t = t.memoizedProps["data-testname"]) && t.toLowerCase() === e.value.toLowerCase())
                        return !0;
                    break;
                default:
                    throw Error(d(365))
            ...
            var i2 = Math.ceil
              , i4 = c.ReactCurrentDispatcher
              , i3 = c.ReactCurrentOwner
            ...
            var af = !1
              ...
              , ax = 0;
            function aw() {
                return 0 != (6 & i6) ? eM() : -1 !== aS ? aS : aS = eM()
            }
            function aC(t) {
                return 0 == (1 & t.mode) ? 1 : 0 != (2 & i6) && 0 !== i9 ? i9 & -i9 : null !== rs.transition ? (0 === ax && (ax = eS()),
                ax) : 0 !== (t = ek) ? t : te()
            }
            function ak(t, e, r, n) {
                if (50 < ab)
                    ...
                    Error(d(185));
                ew(t, r, n),
                (0 == (2 & i6) || t !== i8) && (t === i8 && (0 == (2 & i6) && (aa |= r),
                4 === ar && aN(t, i9)),
                aP(t, n),
                1 === r && 0 === i6 && 0 == (1 & e.mode) && (ac(),
                eU && eV()))
            }
            function aP(t, e) {
                var r, n = t.callbackNode;
                !function(t, e) {
                    for (var r = t.suspendedLanes, n = t.pingedLanes, i = t.expirationTimes, a = t.pendingLanes; 0 < a; ) {
                        var o = 31 - ef(a)
                          , s = 1 << o
                          , l = i[o];
                        -1 === l ? (0 == (s & r) || 0 != (s & n)) && (i[o] = function(t, e) {
                            switch (t) {
                            case 1:
                            case 2:
                            case 4:
                        ...
                        }(s, e)) : l <= e && (t.expiredLanes |= s),
                        a &= ~s
                    }
                }(t, e);
                var i = eb(t, t === i8 ? i9 : 0);
                if (0 === i)
                    null !== n && eF(n),
                    t.callbackNode = null,
                ...
                t.callbackPriority !== e) {
                    if (null != n && eF(n),
                    1 === e)
                        0 === t.tag ? (r = aM.bind(null, t),
                        eU = !0,
                        eH(r)) : eH(aM.bind(null, t)),
                        tn ? ti(function() {
                            0 == (6 & i6) && eV()
                        }) : eT(eA, eV),
                        n = null;
            ...
            function aT(t, e) {
                ...
                if (aH() && t.callbackNode !== r)
                    return null;
                var n = eb(t, t === i8 ? i9 : 0);
                if (0 === n)
                    return null;
                if (0 != (30 & n) || 0 != (n & t.expiredLanes) || e)
                    e = aO(t, n);
                else {
                    e = n;
                    var i = i6;
                    ...
                    if (6 === e)
                        ...
                        case 3:
                            ...
                            (130023424 & n) === n && 10 < (e = ah + 500 - eM())) {
                                ...
                                t.timeoutHandle = K(aB.bind(null, t, al, ad), e);
                                break
                            }
                            aB(t, al, ad);
                            break;
                        case 4:
                            ...
                            if (n = i,
                            10 < (n = (120 > (n = eM() - n) ? 120 : 480 > n ? 480 : 1080 > n ? 1080 : 1920 > n ? 1920 : 3e3 > n ? 3e3 : 4320 > n ? 4320 : 1960 * i2(n / 1960)) - n)) {
                                t.timeoutHandle = K(aB.bind(null, t, al, ad), n);
                                break
                            }
                            aB(t, al, ad);
                            break;
                ...
                return aP(t, eM()),
                t.callbackNode === r ? aT.bind(null, t) : null
            }
            function aF(t, e) {
                var r = as;
                return t.current.memoizedState.isDehydrated && (aD(t, e).flags |= 256),
                2 !== (t = aO(t, e)) && (e = al,
                al = r,
                null !== e && aE(e)),
                t
            ...
            function aE(t) {
                null === al ? al = t : al.push.apply(al, t)
            }
            function aN(t, e) {
                for (e &= ~ao,
                e &= ~aa,
            ...
            function aA(t) {
                null !== am && 0 === am.tag && 0 == (6 & i6) && aH();
                var e = i6;
                i6 |= 1;
                var r = i5.transition
                  , n = ek;
                try {
                    if (i5.transition = null,
                    ek = 1,
                    t)
                        return t()
                } finally {
            ...
            function aD(t, e) {
                ...
                if (r !== q && (t.timeoutHandle = q,
                Y(r)),
                null !== i7)
                    for (r = i7.return; null !== r; ) {
                        var n = r;
                        switch (e2(n),
                        n.tag) {
                        case 1:
                ...
                al = as = null,
                null !== r_) {
                    for (e = 0; e < r_.length; e++)
                        if (null !== (n = (r = r_[e]).interleaved)) {
                            r.interleaved = null;
                            var i = n.next
                              , a = r.pending;
                            if (null !== a) {
            ...
            function aL(t, e) {
                for (; ; ) {
                    ...
                    try {
                        ...
                        r5.current = nV,
                        ne) {
                            for (var n = r7.memoizedState; null !== n; ) {
                                var i = n.queue;
                        ...
                        t: {
                            ...
                            do {
                                ...
                                case 1:
                                    ...
                                    var b = a.type
                                      , _ = a.stateNode;
                                    if (0 == (128 & a.flags) && ("function" == typeof b.getDerivedStateFromError || null !== _ && "function" == typeof _.componentDidCatch && (null === ap || !ap.has(_)))) {
                                        a.flags |= 65536,
                                        e &= -e,
                                        a.lanes |= e;
                                        var S = nJ(a, s, e);
            ...
            function aI() {
                var t = i4.current;
                return i4.current = nV,
                null === t ? nV : t
            }
            function aG() {
                (0 === ar || 3 === ar || 2 === ar) && (ar = 4),
                null === i8 || 0 == (268435455 & ai) && 0 == (268435455 & aa) || aN(i8, i9)
            }
            function aO(t, e) {
                var r = i6;
                i6 |= 2;
                    ...
                    0 == (32768 & r.flags)) {
                        if (null !== (o = function(t, r, o) {
                            ...
                            case 3:
                                ...
                                (null === t || null === t.child) && (rn(r) ? im(r) : null === t || t.memoizedState.isDehydrated && 0 == (256 & r.flags) || (r.flags |= 1024,
                                null !== e8 && (aE(e8),
                                e8 = null))),
                                n(t, r),
                                iS(r),
                            ...
                            case 5:
                                ...
                                if (null !== t && null != r.stateNode)
                                    ...
                                    rn(r)) {
                                        if (!J)
                                            throw Error(d(175));
                                        t = tK(r.stateNode, r.type, r.memoizedProps, o, t, r, !e6),
                                        r.updateQueue = t,
                                        null !== t && im(r)
                                    } else {
                                        var h = U(l, s, o, t, r);
                                ...
                                null;
                            case 6:
                                if (t && null != r.stateNode)
                                    a(t, r, t.memoizedProps, s);
                                else {
                                    ...
                                    rn(r)) {
                                        if (!J)
                                            throw Error(d(176));
                                        if ((s = tY(t = r.stateNode, o = r.memoizedProps, r, !e6)) && null !== (l = e4))
                                            switch (l.tag) {
                                            case 3:
                                                t1(l.stateNode.containerInfo, t, o, 0 != (1 & l.mode));
                                                break;
                                            case 5:
                                                t2(l.type, l.memoizedProps, l.stateNode, t, o, 0 != (1 & l.mode))
                                            }
                                        s && im(r)
                                    } else
                                        r.stateNode = W(s, t, o, r)
                                }
                                return iS(r),
                                null;
                            case 13:
                                ...
                                null === t || null !== t.memoizedState && null !== t.memoizedState.dehydrated) {
                                    if (e5 && null !== e3 && 0 != (1 & r.mode) && 0 == (128 & r.flags))
                                        ri(),
                                        ra(),
                                        r.flags |= 98560,
                                        l = !1;
                                    ...
                                    null !== s && null !== s.dehydrated) {
                                        if (null === t) {
                                            ...
                                            if (!J)
                                                throw Error(d(344));
                                            if (!(l = null !== (l = r.memoizedState) ? l.dehydrated : null))
                                                throw Error(d(317));
                                            tq(l, r)
                                        } else
                                            ra(),
                                ...
                                if (0 != (128 & r.flags))
                                    return r.lanes = o,
                                    r;
                                return (o = null !== s) != (null !== t && null !== t.memoizedState) && o && (r.child.flags |= 8192,
                                0 != (1 & r.mode) && (null === t || 0 != (1 & r1.current) ? 0 === ar && (ar = 3) : aG())),
                            ...
                            case 19:
                                ...
                                null === (h = l.rendering)) {
                                    if (s)
                                        ...
                                        if (0 !== ar || null !== t && 0 != (128 & t.flags))
                                            for (t = r.child; null !== t; ) {
                                                if (null !== (h = r2(t))) {
                                                    for (r.flags |= 128,
                                                    i_(l, !1),
                                                    null !== (t = h.updateQueue) && (r.updateQueue = t,
                                                    r.flags |= 4),
                                                    r.subtreeFlags = 0,
                                                    t = o,
                                                    o = r.child; null !== o; )
                                                        ...
                                                        l = t,
                                                        s.flags &= 14680066,
                                                        null === (h = s.alternate) ? (s.childLanes = 0,
                                                        s.lanes = l,
                                                        s.child = null,
                                                        s.subtreeFlags = 0,
                                                        ...
                                                        s.type = h.type,
                                                        l = h.dependencies,
                                                        s.dependencies = null === l ? null : {
                                                            lanes: l.lanes,
                                                            firstContext: l.firstContext
                                                        }),
                                                        o = o.sibling;
                                                    return ee(r1, 1 & r1.current | 2),
                                                    r.child
                                                }
                                                t = t.sibling
                                            }
                                        null !== l.tail && eM() > au && (r.flags |= 128,
                                        s = !0,
                                        i_(l, !1),
                                        r.lanes = 4194304)
                                    }
                                    ...
                                    if (!s) {
                                        if (null !== (t = r2(h))) {
                                            if (r.flags |= 128,
                                            s = !0,
                                            null !== (t = t.updateQueue) && (r.updateQueue = t,
                                            r.flags |= 4),
                                            i_(l, !0),
                                            null === l.tail && "hidden" === l.tailMode && !h.alternate && !e5)
                                                return iS(r),
                                                null
                                        } else
                                            2 * eM() - l.renderingStartTime > au && 1073741824 !== o && (r.flags |= 128,
                                            s = !0,
                                            i_(l, !1),
                                            r.lanes = 4194304)
                                    }
                                    l.isBackwards ? (h.sibling = r.child,
                                    r.child = h) : (null !== (t = l.last) ? t.sibling = h : r.child = h,
                                    l.last = h)
                                }
                                if (null !== l.tail)
                                    return r = l.tail,
                            ...
                            case 23:
                                ...
                                null !== t && null !== t.memoizedState !== o && (r.flags |= 8192),
                                o && 0 != (1 & r.mode) ? 0 != (1073741824 & at) && (iS(r),
                                Q && 6 & r.subtreeFlags && (r.flags |= 8192)) : iS(r),
                                null;
                            case 24:
                            case 25:
                                return null
                ...
                try {
                    ...
                    function(t, e, r, n) {
                        ...
                        if (null !== r) {
                            ...
                            t === i8 && (i7 = i8 = null,
                            i9 = 0),
                            0 == (2064 & r.subtreeFlags) && 0 == (2064 & r.flags) || av || (av = !0,
                            o = eD,
                            s = function() {
                                return aH(),
                                null
                            ...
                            0 != (15990 & r.subtreeFlags) || a) {
                                                        ...
                                                        case 1:
                                                            if (null !== r) {
                                                                var n = r.memoizedProps
                                                                  , i = r.memoizedState
                                                                  , a = t.stateNode
                                                                  , o = a.getSnapshotBeforeUpdate(t.elementType === t.type ? n : rh(t.type, n), i);
                                ...
                                ik = l,
                                function t(e, r, n) {
                                    for (var i = 0 != (1 & e.mode); null !== ik; ) {
                                        var a = ik
                                          , o = a.child;
                                        if (22 === a.tag && i) {
                                            var s = null !== a.memoizedState || ix;
                                            if (!s) {
                                                var l = a.alternate
                                                  , h = null !== l && null !== l.memoizedState || iw;
                                                l = ix;
                                                var u = iw;
                                                if (ix = s,
                                                (iw = h) && !u)
                                                    for (ik = a; null !== ik; )
                                                        h = (s = ik).child,
                                                        22 === s.tag && null !== s.memoizedState ? ij(a) : null !== h ? (h.return = s,
                                                        ik = h) : ij(a);
                                                for (; null !== o; )
                                                    ik = o,
                                                    t(o, r, n),
                            ...
                            am = t,
                            ay = i),
                            0 === (a = t.pendingLanes) && (ap = null),
                            function(t) {
                                if (eG && "function" == typeof eG.onCommitFiberRoot)
                                    try {
                                        eG.onCommitFiberRoot(eI, t, void 0, 128 == (128 & t.current.flags))
                                    } catch (t) {}
                            }(r.stateNode, n),
                            aP(t, eM()),
                            null !== e)
                            ...
                            if (af)
                                ...
                                t;
                            0 != (1 & ay) && 0 !== t.tag && aH(),
                            0 != (1 & (a = t.pendingLanes)) ? t === a_ ? ab++ : (ab = 0,
                            a_ = t) : ab = 0,
                            eV()
                        }
                    }(t, e, r, n)
                                            ...
                                            for (ik = h; null !== ik; ) {
                                                ...
                                                if (null !== c)
                                                    ...
                                                    for (; null !== ik; ) {
                                                        ...
                                                        if (!function t(e) {
                                                            var r = e.alternate;
                                                            null !== r && (e.alternate = null,
                                                            t(r)),
                                                            e.child = null,
                                                            e.deletions = null,
                                                            e.sibling = null,
                                                            5 === e.tag && null !== (r = e.stateNode) && tr(r),
                                                            e.stateNode = null,
                                                            e.return = null,
                                                            e.dependencies = null,
            ...
            function aj(t, e, r) {
                if (3 === t.tag)
                    ...
                    for (; null !== e; ) {
                        ...
                        if (1 === e.tag) {
                            var n = e.stateNode;
                            if ("function" == typeof e.type.getDerivedStateFromError || "function" == typeof n.componentDidCatch && (null === ap || !ap.has(n))) {
                                t = nJ(e, t = nY(r, t), 1),
                                e = rF(e, t, 1),
                                t = aw(),
                                null !== e && (ew(e, 1, t),
            ...
            function aW(t, e, r) {
                ...
                i8 === t && (i9 & r) === r && (4 === ar || 3 === ar && (130023424 & i9) === i9 && 500 > eM() - ah ? aD(t, 0) : ao |= r),
                aP(t, e)
            }
            function aK(t, e) {
                0 === e && (0 == (1 & t.mode) ? e = 1 : (e = em,
                0 == (130023424 & (em <<= 1)) && (em = 4194304)));
                var r = aw();
                null !== (t = rw(t, e)) && (ew(t, e, r),
                aP(t, r))
            }
            function aY(t) {
                var e = t.memoizedState
                  , r = 0;
                null !== e && (r = e.retryLane),
                aK(t, r)
            }
            function aq(t, e) {
                var r = 0;
            ...
            function aJ(t, e) {
                var r = t.alternate;
                return null === r ? ((r = aQ(t.tag, e, t.key, t.mode)).elementType = t.elementType,
                r.type = t.type,
            ...
            function aZ(t, e, r, n, i, a) {
                ...
                "function" == typeof t)
                    ...
                    t: switch (t) {
                    case p:
                        return a0(r.children, i, a, e);
                    case v:
                        o = 8,
                        i |= 8;
                        break;
                    case m:
                        return (t = aQ(12, r, e, 2 | i)).elementType = m,
                        t.lanes = a,
                        t;
                    case S:
                        return (t = aQ(13, r, e, i)).elementType = S,
                        t.lanes = a,
                        t;
                    case x:
                        return (t = aQ(19, r, e, i)).elementType = x,
                        t.lanes = a,
                        t;
                    case k:
                        return a1(r, i, a, e);
                ...
                return (e = aQ(o, r, e, i)).elementType = t,
                e.type = n,
                e.lanes = a,
                e
            }
            function a0(t, e, r, n) {
                return (t = aQ(7, t, n, e)).lanes = r,
                t
            }
            function a1(t, e, r, n) {
                return (t = aQ(22, t, n, e)).elementType = k,
                t.lanes = r,
                t.stateNode = {
                    isHidden: !1
                },
            ...
            function a2(t, e, r) {
                return (t = aQ(6, t, null, e)).lanes = r,
                t
            }
            function a4(t, e, r) {
                return (e = aQ(4, null !== t.children ? t.children : [], t.key, e)).lanes = r,
                e.stateNode = {
            ...
            return o = function(t, e, r) {
                if (null !== t) {
                    if (t.memoizedProps !== e.pendingProps || ei.current)
                        n4 = !0;
                    else {
                        if (0 == (t.lanes & r) && 0 == (128 & e.flags))
                            ...
                            function(t, e, r) {
                                ...
                                case 4:
                                    ...
                                    break;
                                case 10:
                                    rp(e, e.type._context, e.memoizedProps.value);
                                    break;
                                case 13:
                                    var n = e.memoizedState;
                                    if (null !== n) {
                                        if (null !== n.dehydrated)
                                            return ee(r1, 1 & r1.current),
                                            e.flags |= 128,
                                            null;
                                        if (0 != (r & e.child.childLanes))
                                            return il(t, e, r);
                                        return ee(r1, 1 & r1.current),
                                        null !== (t = iv(t, e, r)) ? t.sibling : null
                                    }
                                    ee(r1, 1 & r1.current);
                                    break;
                                case 19:
                                    if (n = 0 != (r & e.childLanes),
                                    0 != (128 & t.flags)) {
                                        if (n)
                                            return ig(t, e, r);
                                        e.flags |= 128
                    ...
                    n4 = !1,
                    e5 && 0 != (1048576 & e.flags) && e0(e, eY, e.index);
                switch (e.lanes = 0,
                e.tag) {
                case 2:
                    var n = e.type;
                ...
                case 3:
                    t: {
                        ...
                        J && a.isDehydrated) {
                            ...
                            for (J && (e3 = tj(e.stateNode.containerInfo),
                            e4 = e,
                            e5 = !0,
                            e8 = null,
                            e6 = !1),
                ...
                case 5:
                    ...
                    o = i.children,
                    j(n, i) ? o = null : null !== a && j(n, a) && (e.flags |= 32),
                    n9(t, e),
                    n3(t, e, o, r),
                    e.child;
                case 6:
                ...
                case 13:
                    return il(t, e, r);
                case 4:
                    return r$(e, e.stateNode.containerInfo),
                    n = e.pendingProps,
                    null === t ? e.child = rj(e, null, n, r) : n3(t, e, n, r),
                    e.child;
                case 11:
                    return n = e.type,
                    i = e.pendingProps,
                    ...
                    n5(t, e, n, i, r);
                case 7:
                    return n3(t, e, e.pendingProps, r),
                    e.child;
                case 8:
                case 12:
                    return n3(t, e, e.pendingProps.children, r),
                    e.child;
                case 10:
                    t: {
                ...
                case 9:
                    ...
                    e.child;
                case 14:
                    return i = rh(n = e.type, e.pendingProps),
                    i = rh(n.type, i),
                    n6(t, e, n, i, r);
                case 15:
                    return n8(t, e, e.type, e.pendingProps, r);
                case 17:
                    return n = e.type,
                    i = e.pendingProps,
                    i = e.elementType === n ? i : rh(n, i),
            ...
            s.attemptContinuousHydration = function(t) {
                if (13 === t.tag) {
                    var e = rw(t, 134217728);
                    null !== e && ak(e, t, 134217728, aw()),
                    a9(t, 134217728)
                }
            }
            ,
            ...
            s.createHydrationContainer = function(t, e, r, n, i, a, o, s, l) {
                return (t = a5(r, n, !0, t, i, a, o, s, l)).context = a6(null),
                r = t.current,
                (a = rT(n = aw(), i = aC(r))).callback = null != e ? e : null,
                rF(r, a, i),
                t.current.lanes = i,
                ew(t, i, n),
                aP(t, n),
            ...
            s.findBoundingRects = function(t, e) {
                ...
                for (e = t.length - 1; 0 < e; e--) {
                    r = t[e];
                    for (var n = r.x, i = n + r.width, a = r.y, o = a + r.height, s = e - 1; 0 <= s; s--)
                        if (e !== s) {
                            var l = t[s]
                              , h = l.x
                              , u = h + l.width
            ...
            ,
            s.findHostInstance = a8,
            s.findHostInstanceWithNoPortals = function(t) {
                return null === (t = null !== (t = M(t)) ? function t(e) {
                    if (5 === e.tag || 6 === e.tag)
                        return e;
                    for (e = e.child; null !== e; ) {
                        if (4 !== e.tag) {
            ...
            ,
            s.flushPassiveEffects = aH,
            s.flushSync = aA,
            s.focusWithin = function(t, e) {
                if (!ta)
                    throw Error(d(363));
                for (e = Array.from(e = i0(t = i$(t), e)),
                t = 0; t < e.length; ) {
                    var r = e[t++];
                    if (!th(r)) {
                        if (5 === r.tag && td(r.stateNode))
                            return !0;
                        for (r = r.child; null !== r; )
                            e.push(r),
                            r = r.sibling
            ...
            s.getFindAllNodesFailureDescription = function(t, e) {
                ...
                for (var i = 0; i < t.length; ) {
                    var a = t[i++]
                      , o = t[i++]
                      , s = e[o];
                    if ((5 !== a.tag || !th(a)) && (iJ(a, s) && (n.push(iZ(s)),
                    ++o > r && (r = o)),
                    o < e.length))
            ...
            s.getPublicRootInstance = function(t) {
                return (t = t.current).child ? 5 === t.child.tag ? L(t.child.stateNode) : t.child.stateNode : null
            }
            ,
            s.injectIntoDevTools = function(t) {
                if (t = {
                    ...
                    findFiberByHostInstance: t.findFiberByHostInstance || oe,
            ...
            s.observeVisibleRects = function(t, e, r, n) {
                if (!ta)
                    throw Error(d(363));
                var i = tc(t = i1(t, e), r, n).disconnect;
                return {
                    disconnect: function() {
                        i()
                    }
            ...
            s.registerMutableSourceForHydration = function(t, e) {
                var r = e._getVersion;
                r = r(e._source),
                null == t.mutableSourceEagerHydrationData ? t.mutableSourceEagerHydrationData = [e, r] : t.mutableSourceEagerHydrationData.push(e, r)
            }
            ,
 ...
 */
        ...
        function w(t, r) {
            ...
            try {
                for (S(r),
                f = n(u); null !== f && (!(f.expirationTime > r) || t && !E()); ) {
                    var o = f.callback;
        ...
        e.unstable_forceFrameRate = function(t) {
            0 > t || 125 < t ? console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported") : T = 0 < t ? Math.floor(1e3 / t) : 5
        }
        ,
        ...
        e.unstable_scheduleCallback = function(t, i, a) {
            ...
            a > o ? (t.sortIndex = a,
            r(d, t),
            null === n(u) && t === n(d) && (m ? (b(P),
            P = -1) : m = !0,
            D(x, a - o))) : (t.sortIndex = s,
            r(u, t),
            v || p || (v = !0,
            R(w))),
            t
